...
export const STATUS = {
  pending: { ko: '아직 필요해요', en: 'Not yet', 'zh-CN': '还需要', ja: 'まだ必要です', vi: 'Chưa hoàn tất', tl: 'Hindi pa', id: 'Belum', ru: 'Ещё нужно', fr: 'Pas encore', es: 'Aún falta', ar: 'لا يزال مطلوبًا', de: 'Noch nicht', icon: '⬜' },
  ready: { ko: '후보를 찾았어요', en: 'Candidate found', 'zh-CN': '已找到候选', ja: '候補が見つかりました', vi: 'Đã tìm thấy ứng viên', tl: 'May nahanap na kandidato', id: 'Kandidat ditemukan', ru: 'Найден кандидат', fr: 'Candidat trouvé', es: 'Candidato encontrado', ar: 'تم العثور على مرشح', de: 'Kandidat gefunden', icon: '🔵' },
  needs_confirmation: { ko: '확인이 필요해요', en: 'Quick check needed', 'zh-CN': '需要确认', ja: '確認が必要です', vi: 'Cần kiểm tra', tl: 'Kailangan ng mabilis na pagtsek', id: 'Perlu konfirmasi', ru: 'Нужна проверка', fr: 'Vérification requise', es: 'Requiere comprobación', ar: 'يلزم التحقق', de: 'Prüfung nötig', icon: '⚠️' },
  complete: { ko: '선택했어요', en: 'Selected', 'zh-CN': '已选择', ja: '選択しました', vi: 'Đã chọn', tl: 'Napili na', id: 'Sudah dipilih', ru: 'Выбрано', fr: 'Sélectionné', es: 'Seleccionado', ar: 'تم الاختيار', de: 'Ausgewählt', icon: '✅' },
  blocked: { ko: '조금 더 알려주세요', en: 'Add a detail', 'zh-CN': '请再补充一点', ja: 'もう少し教えてください', vi: 'Cho thêm chi tiết', tl: 'Magdagdag ng detalye', id: 'Tambahkan detail', ru: 'Добавьте детали', fr: 'Ajoutez un détail', es: 'Añada un detalle', ar: 'أضف تفصيلًا', de: 'Detail ergänzen', icon: '✏️' }
};
...
export const CHECKLIST_COPY = {
  ...
  'reason.industry.needs_code': { ko: '입력은 이해했지만 공식 업종 코드는 확인이 필요해요 (공식 코드 확인 필요).', en: 'Understood, but the official industry code needs confirmation.', 'zh-CN': '已理解您的输入，但官方行业代码仍需确认（需确认官方代码）。', ja: '入力は理解しましたが、公式の業種コードは確認が必要です（公式コードの確認が必要）。', vi: 'Đã hiểu nội dung nhập, nhưng mã ngành chính thức cần được xác nhận (cần xác nhận mã chính thức).', tl: 'Naintindihan ang input, ngunit kailangan pang kumpirmahin ang opisyal na industry code (kailangan ng kumpirmasyon sa opisyal na code).', id: 'Masukan Anda dipahami, tetapi kode industri resmi masih perlu dikonfirmasi (perlu konfirmasi kode resmi).', ru: 'Ввод понят, но официальный код отрасли требует подтверждения (требуется подтверждение официального кода).', fr: 'Entrée comprise, mais le code de secteur officiel doit être confirmé (confirmation du code officiel requise).', es: 'Entendimos su entrada, pero el código oficial del sector necesita confirmación (se requiere confirmar el código oficial).', ar: 'فُهم الإدخال، لكن رمز القطاع الرسمي يحتاج إلى تأكيد (يلزم تأكيد الرمز الرسمي).', de: 'Eingabe verstanden, aber der offizielle Branchencode muss bestätigt werden (Bestätigung des offiziellen Codes erforderlich).' },
  'reason.industry.complete': { ko: '업종 후보를 선택했어요. 최종값은 하이코리아에서 확인하세요.', en: 'Industry selected — confirm the final value on HiKorea.', 'zh-CN': '已选择行业候选。最终值请在 HiKorea 确认。', ja: '業種候補を選択しました。最終的な値はHiKoreaで確認してください。', vi: 'Đã chọn ứng viên ngành. Hãy xác nhận giá trị cuối cùng trên HiKorea.', tl: 'Napili na ang industriya — kumpirmahin ang huling halaga sa HiKorea.', id: 'Industri dipilih — konfirmasi nilai akhirnya di HiKorea.', ru: 'Отрасль выбрана — подтвердите итоговое значение на HiKorea.', fr: 'Secteur sélectionné — confirmez la valeur finale sur HiKorea.', es: 'Sector seleccionado — confirme el valor final en HiKorea.', ar: 'تم اختيار القطاع — أكّد القيمة النهائية في HiKorea.', de: 'Branche ausgewählt — bestätigen Sie den endgültigen Wert auf HiKorea.' },
  'reason.industry.blocked': { ko: '회사/사업장이 무슨 일을 하는지 적으면 업종 후보를 찾을 수 있어요.', en: 'Tell us what your employer/business does to find industry candidates.', 'zh-CN': '写明公司/营业场所做什么业务，即可找到行业候选。', ja: '会社・事業所が何をしているかを書くと業種候補が見つかります。', vi: 'Hãy ghi rõ công ty/cơ sở kinh doanh làm gì để tìm ứng viên ngành.', tl: 'Sabihin kung ano ang ginagawa ng employer/negosyo mo para makahanap ng kandidatong industriya.', id: 'Tuliskan apa yang dilakukan perusahaan/tempat usaha untuk menemukan kandidat industri.', ru: 'Укажите, чем занимается ваш работодатель/предприятие, чтобы найти кандидатов отраслей.', fr: 'Indiquez ce que fait votre employeur/établissement pour trouver des secteurs.', es: 'Indique qué hace su empleador/negocio para encontrar sectores.', ar: 'اكتب ما تقوم به الشركة/مكان العمل للعثور على مرشّحي القطاعات.', de: 'Geben Sie an, was Ihr Arbeitgeber/Betrieb tut, um Branchenkandidaten zu finden.' },

  'reason.income.pending': { ko: '하이코리아에서 실제 연간소득 구간을 선택해야 합니다 (과세 전 기준).', en: 'Select your actual annual income bracket on HiKorea (pre-tax).', 'zh-CN': '须在 HiKorea 选择实际年收入区间（以税前为准）。', ja: 'HiKoreaで実際の年間所得区分を選択する必要があります（税引き前を基準）。', vi: 'Bạn phải chọn khoảng thu nhập hằng năm thực tế trên HiKorea (theo mức trước thuế).', tl: 'Kailangan mong piliin ang aktwal na taunang income bracket sa HiKorea (bago ang buwis).', id: 'Anda harus memilih rentang penghasilan tahunan yang sebenarnya di HiKorea (sebelum pajak).', ru: 'Выберите фактический диапазон годового дохода на HiKorea (до уплаты налогов).', fr: 'Sélectionnez votre tranche de revenu annuel réelle sur HiKorea (avant impôt).', es: 'Seleccione su tramo de ingresos anuales real en HiKorea (antes de impuestos).', ar: 'يجب اختيار شريحة الدخل السنوي الفعلية في HiKorea (قبل الضريبة).', de: 'Wählen Sie Ihre tatsächliche Jahreseinkommensstufe auf HiKorea (vor Steuern).' },
  'reason.income.complete': { ko: '소득 구간을 임시로 골랐어요. 최종 선택은 하이코리아에서 확인하세요.', en: 'Income bracket drafted — confirm the final choice on HiKorea.', 'zh-CN': '已暂选收入区间。最终选择请在 HiKorea 确认。', ja: '所得区分を仮に選びました。最終的な選択はHiKoreaで確認してください。', vi: 'Đã chọn tạm khoảng thu nhập. Hãy xác nhận lựa chọn cuối cùng trên HiKorea.', tl: 'Pansamantalang napili ang income bracket — kumpirmahin ang huling pagpili sa HiKorea.', id: 'Rentang penghasilan dipilih sementara — konfirmasi pilihan akhir di HiKorea.', ru: 'Диапазон дохода выбран предварительно — подтвердите окончательный выбор на HiKorea.', fr: 'Tranche de revenu provisoire — confirmez le choix final sur HiKorea.', es: 'Tramo de ingresos provisional — confirme la elección final en HiKorea.', ar: 'تم اختيار شريحة الدخل مؤقتًا — أكّد الاختيار النهائي في HiKorea.', de: 'Einkommensstufe vorläufig gewählt — bestätigen Sie die endgültige Wahl auf HiKorea.' },

  'reason.hikorea.pending': { ko: '검색을 마치면 하이코리아에서 최종 확인할 항목을 정리해 드려요.', en: 'After searching, we\'ll list what to confirm on HiKorea.', 'zh-CN': '搜索结束后，我们会为您整理出需在 HiKorea 最终确认的事项。', ja: '検索を終えると、HiKoreaで最終確認すべき項目を整理してお見せします。', vi: 'Sau khi tìm kiếm xong, chúng tôi sẽ tổng hợp những mục cần xác nhận cuối cùng trên HiKorea.', tl: 'Pagkatapos maghanap, ililista namin kung ano ang kumpirmahin sa HiKorea.', id: 'Setelah pencarian selesai, kami akan merangkum hal yang perlu dikonfirmasi di HiKorea.', ru: 'После поиска мы перечислим, что нужно подтвердить на HiKorea.', fr: 'Après votre recherche, nous listerons ce qu\'il faut confirmer sur HiKorea.', es: 'Tras buscar, enumeraremos lo que debe confirmar en HiKorea.', ar: 'بعد انتهاء البحث سنرتّب لك العناصر التي يلزم تأكيدها نهائيًا في HiKorea.', de: 'Nach der Suche listen wir auf, was Sie auf HiKorea bestätigen müssen.' },
  'reason.hikorea.needs_confirmation': { ko: '최종 신고는 하이코리아 화면에서 직접 확인·선택해야 합니다. Paradiso는 후보만 찾아드려요.', en: 'Final reporting is done on HiKorea itself — Paradiso only finds candidates.', 'zh-CN': '最终申报须在 HiKorea 界面亲自确认·选择。Paradiso 仅为您查找候选。', ja: '最終申告はHiKoreaの画面でご自身が確認・選択する必要があります。Paradisoは候補をお探しするだけです。', vi: 'Việc khai báo cuối cùng phải do bạn tự xác nhận và chọn trên màn hình HiKorea. Paradiso chỉ tìm ứng viên.', tl: 'Ang huling pag-uulat ay sa HiKorea mismo gagawin — si Paradiso ay naghahanap lang ng mga kandidato.', id: 'Pelaporan akhir harus Anda konfirmasi dan pilih sendiri di layar HiKorea. Paradiso hanya menemukan kandidat.', ru: 'Окончательная подача выполняется на самом HiKorea — Paradiso только подбирает кандидатов.', fr: 'La déclaration finale se fait sur HiKorea même — Paradiso ne fait que trouver des candidats.', es: 'La declaración final se realiza en la propia HiKorea — Paradiso solo busca candidatos.', ar: 'الإبلاغ النهائي يتم على شاشة HiKorea نفسها — أما Paradiso فيكتفي بإيجاد المرشّحين.', de: 'Die endgültige Meldung erfolgt auf HiKorea selbst — Paradiso findet nur Kandidaten.' },

  'section.occupation': { ko: '직종 후보: 내가 하는 일에 가까운 항목', en: 'Occupation candidates: closest to what you do', 'zh-CN': '职业候选：与您所做工作最接近的项目', ja: '職種候補：あなたの仕事に最も近い項目', vi: 'Ứng viên nghề nghiệp: mục gần nhất với việc bạn làm', tl: 'Mga kandidatong occupation: pinakamalapit sa ginagawa mo', id: 'Kandidat pekerjaan: paling dekat dengan yang Anda lakukan', ru: 'Кандидаты профессий: ближайшие к тому, что вы делаете', fr: 'Professions candidates : les plus proches de votre travail', es: 'Ocupaciones candidatas: las más cercanas a lo que hace', ar: 'مرشّحو المهن: الأقرب إلى ما تقوم به', de: 'Berufskandidaten: am nächsten zu Ihrer Tätigkeit' },
  'section.industry': { ko: '업종 후보: 회사/사업장이 하는 일에 가까운 항목', en: 'Industry candidates: closest to your employer\'s business', 'zh-CN': '行业候选：与公司/营业场所业务最接近的项目', ja: '業種候補：会社・事業所が行う事業に最も近い項目', vi: 'Ứng viên ngành: mục gần nhất với hoạt động của công ty/cơ sở kinh doanh', tl: 'Mga kandidatong industriya: pinakamalapit sa negosyo ng employer mo', id: 'Kandidat industri: paling dekat dengan usaha perusahaan Anda', ru: 'Кандидаты отраслей: ближайшие к деятельности вашего работодателя', fr: 'Secteurs candidats : les plus proches de l\'activité de votre employeur', es: 'Sectores candidatos: los más cercanos a la actividad de su empleador', ar: 'مرشّحو القطاعات: الأقرب إلى نشاط الشركة/مكان العمل', de: 'Branchenkandidaten: am nächsten zur Tätigkeit Ihres Arbeitgebers' },
  'caution.main': { ko: 'Paradiso는 신고용 직종·업종 후보를 찾는 도구예요. 실제 신고 시에는 하이코리아 화면에서 최종 선택값을 확인하세요. (해당 체류자격에서 취업이 가능한지는 판단하지 않아요.)', en: 'Paradiso finds occupation/industry candidates for reporting. Always confirm the final values on HiKorea. (It does not decide whether your visa permits the work.)', 'zh-CN': 'Paradiso 是用于查找申报用职业·行业候选的工具。实际申报时，请在 HiKorea 界面确认最终选择值。（不判断该居留资格是否允许就业。）', ja: 'Paradisoは申告用の職種・業種候補を探すツールです。実際の申告時には、HiKoreaの画面で最終的な選択値を確認してください。（当該の在留資格で就業が可能かどうかは判断しません。）', vi: 'Paradiso là công cụ tìm ứng viên nghề nghiệp·ngành để khai báo. Khi khai báo thực tế, hãy xác nhận giá trị lựa chọn cuối cùng trên màn hình HiKorea. (Công cụ không phán định liệu tư cách lưu trú đó có cho phép làm việc hay không.)', tl: 'Ang Paradiso ay kasangkapan para maghanap ng mga kandidatong occupation·industriya para sa pag-uulat. Sa aktwal na pag-uulat, kumpirmahin ang mga huling halaga sa screen ng HiKorea. (Hindi nito tinutukoy kung pinapayagan ng iyong visa ang trabaho.)', id: 'Paradiso adalah alat untuk menemukan kandidat pekerjaan·industri untuk pelaporan. Saat pelaporan sebenarnya, konfirmasi nilai pilihan akhir di layar HiKorea. (Alat ini tidak menilai apakah status tinggal tersebut mengizinkan bekerja.)', ru: 'Paradiso — это инструмент для поиска кандидатов профессий·отраслей для отчётности. При фактической подаче подтверждайте итоговые значения на экране HiKorea. (Он не определяет, разрешает ли ваш статус пребывания эту работу.)', fr: 'Paradiso est un outil pour trouver des professions·secteurs candidats à des fins de déclaration. Lors de la déclaration réelle, confirmez les valeurs finales sur l\'écran HiKorea. (Il ne décide pas si votre statut de séjour autorise ce travail.)', es: 'Paradiso es una herramienta para buscar ocupaciones·sectores candidatos para la declaración. En la declaración real, confirme los valores finales en la pantalla de HiKorea. (No determina si su estatus de estancia permite el trabajo.)', ar: 'Paradiso أداة للبحث عن مرشّحي المهن·القطاعات لأغراض الإبلاغ. عند الإبلاغ الفعلي، أكّد القيم النهائية على شاشة HiKorea. (لا يحدّد ما إذا كان وضع الإقامة المعني يسمح بالعمل.)', de: 'Paradiso ist ein Werkzeug, um Berufs-·Branchenkandidaten für die Meldung zu finden. Bestätigen Sie bei der tatsächlichen Meldung die endgültigen Werte auf dem HiKorea-Bildschirm. (Es entscheidet nicht, ob Ihr Aufenthaltstitel die Arbeit erlaubt.)' },
  'weak.title': { ko: '입력하신 내용만으로는 직종과 업종을 나누기 어려워요.', en: 'This input alone is hard to split into occupation and industry.', 'zh-CN': '仅凭您输入的内容，难以区分职业和行业。', ja: 'ご入力の内容だけでは、職種と業種を分けるのが難しいです。', vi: 'Chỉ với nội dung bạn nhập, khó tách thành nghề nghiệp và ngành.', tl: 'Sa input na ito lang, mahirap hatiin sa occupation at industriya.', id: 'Hanya dengan masukan ini, sulit memisahkan pekerjaan dan industri.', ru: 'Только по этому вводу трудно разделить профессию и отрасль.', fr: 'Avec cette seule saisie, il est difficile de distinguer profession et secteur.', es: 'Solo con esta entrada es difícil separar ocupación y sector.', ar: 'يصعب فصل المهنة عن القطاع بالاعتماد على ما أدخلته فقط.', de: 'Allein mit dieser Eingabe lässt sich Beruf und Branche schwer trennen.' },
  'weak.hint': { ko: '아래처럼 입력하면 더 정확해져요.', en: 'Try inputs like these for a better match.', 'zh-CN': '像下面这样输入会更准确。', ja: '下のように入力するとより正確になります。', vi: 'Hãy nhập như bên dưới để kết quả chính xác hơn.', tl: 'Subukan ang mga input na tulad nito para mas tumpak.', id: 'Coba masukan seperti ini agar lebih akurat.', ru: 'Попробуйте такой ввод для более точного совпадения.', fr: 'Essayez des saisies comme celles-ci pour un meilleur résultat.', es: 'Pruebe entradas como estas para una mejor coincidencia.', ar: 'جرّب إدخالات مثل هذه للحصول على نتيجة أدق.', de: 'Versuchen Sie Eingaben wie diese für eine bessere Übereinstimmung.' },
  'weak.detail.place': { ko: '일하는 장소', en: 'Where you work', 'zh-CN': '工作地点', ja: '働く場所', vi: 'Nơi bạn làm việc', tl: 'Kung saan ka nagtatrabaho', id: 'Tempat Anda bekerja', ru: 'Где вы работаете', fr: 'Où vous travaillez', es: 'Dónde trabaja', ar: 'مكان عملك', de: 'Wo Sie arbeiten' },
  'weak.detail.task': { ko: '하는 일', en: 'What you do', 'zh-CN': '所做的工作', ja: '行う仕事', vi: 'Việc bạn làm', tl: 'Ang ginagawa mo', id: 'Apa yang Anda lakukan', ru: 'Что вы делаете', fr: 'Ce que vous faites', es: 'Lo que hace', ar: 'ما تقوم به', de: 'Was Sie tun' },
  'weak.detail.business': { ko: '회사/사업장이 하는 일', en: 'What the employer/business does', 'zh-CN': '公司/营业场所所做的业务', ja: '会社・事業所が行う事業', vi: 'Việc công ty/cơ sở kinh doanh làm', tl: 'Ang ginagawa ng employer/negosyo', id: 'Apa yang dilakukan perusahaan/tempat usaha', ru: 'Чем занимается работодатель/предприятие', fr: 'Ce que fait l\'employeur/l\'établissement', es: 'Lo que hace el empleador/negocio', ar: 'ما تقوم به الشركة/مكان العمل', de: 'Was der Arbeitgeber/Betrieb tut' },
  'clarify.lead': { ko: '정확도를 높이려면 이것만 확인해 주세요.', en: 'One more detail will improve the match.', 'zh-CN': '为提高准确度，只需确认这一点。', ja: '正確さを高めるために、これだけ確認してください。', vi: 'Để tăng độ chính xác, chỉ cần xác nhận điều này.', tl: 'Para mas tumpak, kumpirmahin lang ito.', id: 'Untuk meningkatkan akurasi, cukup konfirmasi ini.', ru: 'Чтобы повысить точность, подтвердите только это.', fr: 'Pour améliorer la précision, confirmez seulement ceci.', es: 'Para mayor precisión, solo confirme esto.', ar: 'لزيادة الدقة، أكّد هذا فقط.', de: 'Für mehr Genauigkeit bestätigen Sie nur dies.' },
  'card.fit': { ko: '이 항목이 맞을 수 있는 경우', en: 'This may fit when', 'zh-CN': '该项目可能合适的情况', ja: 'この項目が当てはまる場合', vi: 'Mục này có thể phù hợp khi', tl: 'Maaaring bagay ito kapag', id: 'Item ini mungkin cocok jika', ru: 'Этот вариант может подойти, когда', fr: 'Cet élément peut convenir lorsque', es: 'Esta opción puede encajar cuando', ar: 'قد يناسب هذا العنصر عندما', de: 'Dies könnte passen, wenn' },
  'card.other': { ko: '다른 항목이 맞을 수 있는 경우', en: 'Another may fit when', 'zh-CN': '其他项目可能更合适的情况', ja: '別の項目が当てはまる場合', vi: 'Mục khác có thể phù hợp khi', tl: 'Maaaring bagay ang iba kapag', id: 'Item lain mungkin cocok jika', ru: 'Другой вариант может подойти, когда', fr: 'Un autre élément peut convenir lorsque', es: 'Otra opción puede encajar cuando', ar: 'قد يناسب عنصر آخر عندما', de: 'Ein anderes könnte passen, wenn' },
  'card.needsCode': { ko: '공식 코드 확인 필요', en: 'Official code needs confirmation', 'zh-CN': '需确认官方代码', ja: '公式コードの確認が必要', vi: 'Cần xác nhận mã chính thức', tl: 'Kailangan ng kumpirmasyon sa opisyal na code', id: 'Perlu konfirmasi kode resmi', ru: 'Требуется подтверждение официального кода', fr: 'Code officiel à confirmer', es: 'El código oficial necesita confirmación', ar: 'يلزم تأكيد الرمز الرسمي', de: 'Offizieller Code muss bestätigt werden' },
  // HiKorea final step shows an action label, never a "complete" one.
  'status.hikorea': { ko: '하이코리아에서 확인해 주세요', en: 'Confirm in HiKorea', 'zh-CN': '请在 HiKorea 确认', ja: 'HiKoreaで確認してください', vi: 'Hãy xác nhận trên HiKorea', tl: 'Kumpirmahin sa HiKorea', id: 'Konfirmasi di HiKorea', ru: 'Подтвердите на HiKorea', fr: 'Confirmez sur HiKorea', es: 'Confirme en HiKorea', ar: 'أكّد عبر HiKorea', de: 'Auf HiKorea bestätigen' },

  // Toss-inspired guided UI copy (keyed for every locale; rendered by index.html).
  'interpret.title': { ko: '이렇게 이해했어요', en: 'Here’s how Paradiso understood your input', 'zh-CN': 'Paradiso 是这样理解您输入的', ja: 'Paradisoはこう理解しました', vi: 'Paradiso đã hiểu nội dung bạn nhập như thế này', tl: 'Ganito naintindihan ng Paradiso ang input mo', id: 'Beginilah Paradiso memahami masukan Anda', ru: 'Вот как Paradiso понял ваш ввод', fr: 'Voici comment Paradiso a compris votre saisie', es: 'Así entendió Paradiso su entrada', ar: 'هكذا فهم Paradiso ما أدخلته', de: 'So hat Paradiso Ihre Eingabe verstanden' },
  'interpret.place': { ko: '일하는 곳', en: 'Where you work', 'zh-CN': '工作地点', ja: '働く場所', vi: 'Nơi làm việc', tl: 'Lugar ng trabaho', id: 'Tempat bekerja', ru: 'Место работы', fr: 'Lieu de travail', es: 'Lugar de trabajo', ar: 'مكان العمل', de: 'Arbeitsort' },
  'interpret.object': { ko: '대상', en: 'What you handle', 'zh-CN': '处理的对象', ja: '対象', vi: 'Đối tượng xử lý', tl: 'Ang hinahawakan', id: 'Objek yang ditangani', ru: 'С чем работаете', fr: 'Ce que vous traitez', es: 'Lo que maneja', ar: 'ما تتعامل معه', de: 'Womit Sie arbeiten' },
  'interpret.action': { ko: '하는 일', en: 'What you do', 'zh-CN': '所做的工作', ja: '行う仕事', vi: 'Việc làm', tl: 'Ang ginagawa', id: 'Yang dilakukan', ru: 'Что вы делаете', fr: 'Ce que vous faites', es: 'Lo que hace', ar: 'ما تقوم به', de: 'Was Sie tun' },
  'interpret.check': { ko: '더 확인할 점', en: 'Still to confirm', 'zh-CN': '仍需确认的点', ja: 'さらに確認する点', vi: 'Điểm cần xác nhận thêm', tl: 'Dapat pang tiyakin', id: 'Yang masih perlu dipastikan', ru: 'Ещё нужно подтвердить', fr: 'Encore à confirmer', es: 'Aún por confirmar', ar: 'ما يلزم تأكيده أيضًا', de: 'Noch zu bestätigen' },
  'clarify.dunno': { ko: '잘 모르겠어요', en: 'Not sure', 'zh-CN': '不太清楚', ja: 'よくわかりません', vi: 'Không chắc', tl: 'Hindi sigurado', id: 'Tidak yakin', ru: 'Не уверен(а)', fr: 'Je ne sais pas', es: 'No estoy seguro', ar: 'لست متأكدًا', de: 'Nicht sicher' },
  'conf.high': { ko: '가장 가까움', en: 'Closest', 'zh-CN': '最接近', ja: '最も近い', vi: 'Gần nhất', tl: 'Pinakamalapit', id: 'Paling dekat', ru: 'Ближайший', fr: 'Le plus proche', es: 'El más cercano', ar: 'الأقرب', de: 'Am nächsten' },
  'conf.mid': { ko: '비슷함', en: 'Similar', 'zh-CN': '相似', ja: '類似', vi: 'Tương tự', tl: 'Magkatulad', id: 'Mirip', ru: 'Похожий', fr: 'Similaire', es: 'Similar', ar: 'مشابه', de: 'Ähnlich' },
  'conf.low': { ko: '가능성 있음', en: 'Possible', 'zh-CN': '有可能', ja: '可能性あり', vi: 'Có thể', tl: 'Posible', id: 'Mungkin', ru: 'Возможно', fr: 'Possible', es: 'Posible', ar: 'محتمل', de: 'Möglich' },
  'group.top': { ko: '가장 가까운 후보', en: 'Closest candidate', 'zh-CN': '最接近的候选', ja: '最も近い候補', vi: 'Ứng viên gần nhất', tl: 'Pinakamalapit na kandidato', id: 'Kandidat paling dekat', ru: 'Ближайший кандидат', fr: 'Candidat le plus proche', es: 'Candidato más cercano', ar: 'المرشّح الأقرب', de: 'Nächster Kandidat' },
  'group.others': { ko: '다른 가능성', en: 'Other possibilities', 'zh-CN': '其他可能', ja: 'その他の可能性', vi: 'Khả năng khác', tl: 'Iba pang posibilidad', id: 'Kemungkinan lain', ru: 'Другие варианты', fr: 'Autres possibilités', es: 'Otras posibilidades', ar: 'احتمالات أخرى', de: 'Weitere Möglichkeiten' },
  'group.several': { ko: '몇 가지 가능성이 있어요', en: 'A few possibilities', 'zh-CN': '有几种可能', ja: 'いくつかの可能性があります', vi: 'Có một vài khả năng', tl: 'May ilang posibilidad', id: 'Ada beberapa kemungkinan', ru: 'Есть несколько вариантов', fr: 'Quelques possibilités', es: 'Hay varias posibilidades', ar: 'هناك عدة احتمالات', de: 'Mehrere Möglichkeiten' },
  'card.source': { ko: '공식 분류 코드', en: 'Official classification code', 'zh-CN': '官方分类代码', ja: '公式分類コード', vi: 'Mã phân loại chính thức', tl: 'Opisyal na classification code', id: 'Kode klasifikasi resmi', ru: 'Официальный код классификации', fr: 'Code de classification officiel', es: 'Código de clasificación oficial', ar: 'رمز التصنيف الرسمي', de: 'Offizieller Klassifikationscode' },
  'card.detail': { ko: '자세히 보기', en: 'See details', 'zh-CN': '查看详情', ja: '詳細を見る', vi: 'Xem chi tiết', tl: 'Tingnan ang detalye', id: 'Lihat detail', ru: 'Подробнее', fr: 'Voir les détails', es: 'Ver detalles', ar: 'عرض التفاصيل', de: 'Details anzeigen' },
  'more.show': { ko: '더 보기', en: 'Show more', 'zh-CN': '查看更多', ja: 'もっと見る', vi: 'Xem thêm', tl: 'Magpakita pa', id: 'Tampilkan lainnya', ru: 'Показать ещё', fr: 'Afficher plus', es: 'Mostrar más', ar: 'عرض المزيد', de: 'Mehr anzeigen' },
  'more.hide': { ko: '접기', en: 'Show less', 'zh-CN': '收起', ja: '閉じる', vi: 'Thu gọn', tl: 'Magpakita ng mas kaunti', id: 'Sembunyikan', ru: 'Свернуть', fr: 'Afficher moins', es: 'Mostrar menos', ar: 'عرض أقل', de: 'Weniger anzeigen' },
  'needcode.title': { ko: '공식 코드 확인 필요', en: 'Official code needs confirmation', 'zh-CN': '需确认官方代码', ja: '公式コードの確認が必要', vi: 'Cần xác nhận mã chính thức', tl: 'Kailangan ng kumpirmasyon sa opisyal na code', id: 'Perlu konfirmasi kode resmi', ru: 'Требуется подтверждение официального кода', fr: 'Code officiel à confirmer', es: 'El código oficial necesita confirmación', ar: 'يلزم تأكيد الرمز الرسمي', de: 'Offizieller Code muss bestätigt werden' },
  'needcode.body': { ko: '입력하신 업무는 해석할 수 있지만, 하이코리아에서 실제 선택할 공식 코드까지는 최종 확인이 필요해요.', en: 'Paradiso can read your work, but the exact official code to pick in HiKorea still needs a final check.', 'zh-CN': '您输入的工作可以被解读，但在 HiKorea 实际选择的官方代码仍需最终确认。', ja: '入力された業務は解釈できますが、HiKoreaで実際に選択する公式コードまでは最終確認が必要です。', vi: 'Có thể đọc hiểu công việc bạn nhập, nhưng mã chính thức thực tế cần chọn trên HiKorea vẫn cần kiểm tra cuối cùng.', tl: 'Mababasa ng Paradiso ang trabaho mo, ngunit kailangan pa ng huling pagtsek ang eksaktong opisyal na code na pipiliin sa HiKorea.', id: 'Pekerjaan yang Anda masukkan dapat dipahami, tetapi kode resmi yang benar-benar dipilih di HiKorea masih perlu pemeriksaan akhir.', ru: 'Paradiso понимает вашу работу, но точный официальный код для выбора на HiKorea всё ещё требует финальной проверки.', fr: 'Paradiso peut interpréter votre travail, mais le code officiel exact à choisir sur HiKorea nécessite encore une vérification finale.', es: 'Paradiso puede interpretar su trabajo, pero el código oficial exacto a elegir en HiKorea aún necesita una comprobación final.', ar: 'يمكن لـ Paradiso تفسير عملك، لكن الرمز الرسمي الدقيق الذي ستختاره في HiKorea لا يزال بحاجة إلى تحقق نهائي.', de: 'Paradiso kann Ihre Tätigkeit deuten, doch der genaue offizielle Code zur Auswahl auf HiKorea braucht noch eine abschließende Prüfung.' },
  ...
  'needcode.portal': { ko: '통계분류포털에서 확인', en: 'Check the classification portal', 'zh-CN': '在统计分类门户确认', ja: '統計分類ポータルで確認', vi: 'Kiểm tra trên cổng phân loại thống kê', tl: 'Tingnan sa classification portal', id: 'Periksa di portal klasifikasi', ru: 'Проверить на портале классификации', fr: 'Vérifier sur le portail de classification', es: 'Consultar en el portal de clasificación', ar: 'تحقّق من بوابة التصنيف', de: 'Im Klassifikationsportal prüfen' },
...
export const CHECKLIST_LANGS = ['ko', 'en', 'zh-CN', 'ja', 'vi', 'tl', 'id', 'ru', 'fr', 'es', 'ar', 'de'];
