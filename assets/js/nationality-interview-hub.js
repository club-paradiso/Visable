...
(function () {
  ...
  var I18N = {
    ...
    ja: {
      ...
      'footer.note': 'Paradiso は公式機関と提携または所属の関係はありません。すべての案内は学習の参考用であり、最終確認は法務部・出入国外国人官署・HiKorea・1345 を通じて行ってください。',
    ...
    vi: {
      ...
      'footer.note': 'Paradiso không liên kết hay trực thuộc bất kỳ cơ quan chính thức nào. Mọi hướng dẫn chỉ để tham khảo học tập; hãy xác nhận với Bộ Tư pháp, cơ quan xuất nhập cảnh, HiKorea hoặc 1345.',
    ...
    tl: {
      ...
      'footer.note': 'Ang Paradiso ay hindi kaugnay o bahagi ng anumang opisyal na ahensya. Lahat ng gabay ay para sa sanggunian sa pag-aaral; kumpirmahin sa Ministri ng Hustisya, tanggapan ng imigrasyon, HiKorea, o 1345.',
    ...
    id: {
      ...
      'footer.note': 'Paradiso tidak berafiliasi atau menjadi bagian dari badan resmi mana pun. Semua panduan untuk referensi belajar; konfirmasikan dengan Kementerian Hukum, kantor imigrasi, HiKorea, atau 1345.',
    ...
    ru: {
      ...
      'footer.note': 'Paradiso не связана и не входит в состав какого-либо официального органа. Все указания предназначены для учебной справки; уточняйте в Министерстве юстиции, миграционном органе, HiKorea или по 1345.',
    ...
    fr: {
      ...
      'footer.note': 'Paradiso n’est ni affilié ni rattaché à un organisme officiel. Toutes les directives sont fournies à titre d’étude ; confirmez auprès du ministère de la Justice, du bureau d’immigration, de HiKorea ou du 1345.',
    ...
    es: {
      ...
      'footer.note': 'Paradiso no está afiliado ni forma parte de ningún organismo oficial. Toda la orientación es de referencia para el estudio; confirme con el Ministerio de Justicia, la oficina de inmigración, HiKorea o el 1345.',
    ...
    ar: {
      ...
      'footer.note': 'Paradiso ليست منتسبة إلى أي جهة رسمية ولا جزءاً منها. كل الإرشادات للمرجعية الدراسية؛ تأكّد لدى وزارة العدل أو مكتب الهجرة أو HiKorea أو 1345.',
    ...
    de: {
      ...
      'footer.note': 'Paradiso ist mit keiner offiziellen Stelle verbunden oder Teil davon. Alle Hinweise dienen der Lernreferenz; bestätigen Sie beim Justizministerium, der Einwanderungsbehörde, HiKorea oder 1345.',
