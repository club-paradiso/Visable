...
(function () {
  ...
  tr: {
    "hero.kicker": "Vatandaşlık hizmetleri ve mülakat hazırlığı",
    "hero.title": "Vatandaşlık hizmetleri ve vatandaşlığa geçiş mülakatı hazırlığı, tek bir yerde",
    "hero.lead": "Vatandaşlığa geçiş, vatandaşlığın yeniden kazanılması, kaybı/vazgeçilmesi, çoklu vatandaşlık, vatandaş yemini ve mülakat hazırlığı — resmi mevzuat ve rehberlere dayanarak durumunuza yakın bir akışı inceleyin, ardından alıştırma soruları ve deneme mülakatıyla hazırlanın.",
    "hero.ctaPrimary": "Mülakat hazırlığına başla",
    "hero.ctaSecondary": "Vatandaşlık hizmetlerine göz at",
    "global.disclaimer": "Bu özellik, vatandaşlık hizmetlerini kontrol etmenize ve vatandaşlığa geçiş mülakatı ile temel bilgi değerlendirmesine hazırlanmanıza yardımcı olan bir öğrenme aracıdır ve herhangi bir inceleme sonucunu garanti etmez. Resmi rehberliği ve bireysel bildirimleri her zaman Adalet Bakanlığı / göçmenlik ofisinden doğrulayın.",
    "about.title": "Vatandaşlık hizmetlerini keşfedin",
    "about.intro": "İlgilendiğiniz bir hizmet türünü seçerek nedir, genellikle kimin içindir, tipik akış, belge uyarıları, ilgili mevzuat ve resmi kaynakları görün. Bireysel durumlar farklılık gösterebilir.",
    "laws.title": "İlgili mevzuat ve kılavuzlar",
    "laws.intro": "Vatandaşlık işlemlerinin dayanağı olan resmi kaynakları türlerine göre inceleyin. Yerel duyurular ve yardımcı açıklama materyalleri ayrıca işaretlenir. Dış bağlantılarla orijinal metinleri doğrudan okuyabilirsiniz.",
    "flow.title": "Prosedür ve belge akışı",
    "flow.intro": "Bir tür seçtiğinizde genel akışı ve belgelerle ilgili uyarıları görebilirsiniz. Kesin sıra, belgeler ve kriterler yetkili göçmenlik ofisinin rehberliğine göre belirlenir ve duruma göre farklılık gösterebilir.",
    "interview.title": "Vatandaşlığa geçiş mülakatı çalışma odası",
    "interview.intro": "Adım adım hazırlanın: süreci anlayın, temel konuları çalışın, alıştırma sorularına göz atın, deneme mülakatı yapın ve referans videoları inceleyin. Her soru alıştırma materyalidir; gerçek ya da resmi bir geçmiş soru değildir.",
    "kiip.title": "Ön değerlendirme / kapsamlı değerlendirme çalışma akışı",
    "kiip.intro": "Sosyal Entegrasyon Programı (KIIP), ön değerlendirmeyle bir seviye atar, ardından seviye bazında çalışmayla kapsamlı değerlendirmeye (vatandaşlığa geçiş sürümü dahil) ilerler. Programı tamamlamak tek başına vatandaşlığa geçiş onayı anlamına gelmez.",
    "videos.title": "Referans videolar / materyaller",
    "videos.intro": "Kullanıcı tarafından sağlanan oynatma listeleri ve kanallar yalnızca referans amacıyla düzenlenmiştir. Altyazı veya deşifreler saklanmaz ve bunlar resmi materyaller değildir.",
    "waymaker.title": "Waymaker vatandaşlık koçu",
    "waymaker.heading": "Sorun ve pratik yapın",
    "waymaker.desc": "Vatandaşlık rehber koçu, mevzuatı rehberlikten ayırarak açıklar; mülakat koçu ise yazdığınız yanıtı inceleyerek daha doğal bir örnek ve bir takip sorusu önerir. Sese gerek olmadan, metin öncelikli olarak ilerler.",
    "waymaker.note": "Geçme durumunu tahmin etmez; bireysel bildirimler ve göçmenlik ofisi rehberliği her zaman önceliklidir.",
    "waymaker.ctaGuide": "Vatandaşlık rehber koçunu aç",
    "waymaker.ctaInterview": "Koç ile deneme mülakatı",
    "badge.official": "Resmi kaynaklara dayalı",
    "badge.notOfficial": "Resmi geçmiş soru değil",
    "badge.unofficialVideo": "Gayriresmi referans",
    "footer.note": "New Home by Paradiso, herhangi bir resmi kurumla bağlı veya ona ait değildir. Tüm rehberlik çalışma amaçlıdır; son doğrulamayı Adalet Bakanlığı, göçmenlik ofisi, HiKorea veya 1345 üzerinden yapın.",
    "footer.back": "← Vatandaşlık ve vatandaşlığa geçiş ana sayfasına",
    "filter.all": "Tümü",
    "who": "Kimler için",
    "flowLabel": "Genel akış",
    "docNote": "Belge uyarıları",
    "relatedLaws": "İlgili mevzuat",
    "relatedSources": "Resmi kaynaklar",
    "caution": "Dikkat",
    "confirmNeeded": "Doğrulama gerekli",
    "caseVaries": "Bireysel duruma göre değişebilir",
    "viewFlow": "Yanıt akışını gör",
    "guidance": "Yanıt rehberi",
    "goodStructure": "İyi bir yanıt yapısı",
    "riskyPatterns": "Kaçınılacak yanıtlar",
    "practiceWaymaker": "Waymaker ile pratik yap",
    "rooms.understand": "Süreci anla",
    "rooms.topics": "Temel konular",
    "rooms.questions": "Alıştırma soruları",
    "rooms.mock": "Deneme mülakatı",
    "rooms.videos": "Referans videolar",
    "randomQ": "Rastgele soru",
    "searchQ": "Soru ara",
    "allCats": "Tüm konular",
    "allDiffs": "Tüm seviyeler",
    "mock.todayQ": "Bugünün alıştırma sorusu",
    "mock.next": "Sonraki soru",
    "mock.placeholder": "Yanıtınızı buraya yazın. Bir neden ve bir örnek eklemek yardımcı olur.",
    "mock.checkLocal": "Yanıtımı kontrol et",
    "mock.startWaymaker": "Waymaker deneme mülakatını başlat",
    "mock.retry": "Yanıtı yeniden yaz",
    "mock.strengths": "Güçlü yönler",
    "mock.improvements": "Geliştirilecekler",
    "mock.risky": "Dikkat edilecek ifadeler",
    "mock.revised": "Daha doğal yanıt örneği",
    "mock.followup": "Sonraki alıştırma sorusu",
    "mock.tip": "Çalışma ipucu",
    "mock.loading": "Waymaker yanıtınızı inceliyor…",
    "mock.aiFail": "AI geri bildirimi yüklenemedi. Lütfen önce temel kontrol sonuçlarını inceleyin.",
    "mock.localTitle": "Temel kontrol (çevrimdışı)",
    "mock.noAnswer": "Lütfen önce bir yanıt yazın.",
    "understand.heading": "Mülakat ve temel bilgi hazırlığı nasıl birbirine bağlanır?",
    "understand.body": "Vatandaşlığa geçiş hazırlığı genellikle Sosyal Entegrasyon Programı (KIIP) çalışması, ön/kapsamlı değerlendirmeler ve vatandaşlığa geçiş incelemesindeki mülakatı birbirine bağlar. Mülakat, ezberlenen yanıtlardan çok temel bilgi ve iletişimi kontrol eder.",
    "understand.warn": "Kimin mülakata alınacağı, içeriği ve muafiyetler bireysel duruma ve bildirime göre değişir. Bu içerik yalnızca çalışma amaçlıdır; bireysel bildiriminiz ve yetkili göçmenlik ofisi her zaman önceliklidir.",
    "understand.steps": "Örnek hazırlık akışı",
    "sourceLabel.official_kiip": "KIIP bağlantılı",
    "sourceLabel.official_socinet": "Değerlendirme bağlantılı",
    "sourceLabel.practice": "Alıştırma",
    "sourceLabel.internal_guidance": "Tutum rehberi",
    "sourceLabel.official_law": "Mevzuat referansı",
    "sourceLabel.official_notice": "Resmi duyuru referansı",
    "sourceLabel.video_reference_topic": "Video konusu",
    "studyFocus": "Çalışma odağı",
    "noResults": "Eşleşen sonuç yok.",
    "videoDisclaimer": "Video materyalleri gayriresmi referanslardır ve gerçek mülakat sorularını veya Adalet Bakanlığı'nın resmi geçmiş sorularını temsil etmez.",
    "openLink": "Aç",
    "difficulty.easy": "Kolay",
    "difficulty.medium": "Orta",
    "difficulty.hard": "Zor",
    "localCheck.tooShort": "Yanıtınız çok kısa. Bir neden ve somut bir deneyim için birer cümle eklemeyi deneyin.",
    "localCheck.direct": "Soruya doğrudan yanıt önce gelirse daha sağlam olur.",
    "localCheck.vague": "İçerik biraz belirsiz. Somut bir örnek veya deneyim ekleyin.",
    "localCheck.structure": "Bir neden ve bir örnek yanıtınıza iyi bir yapı kazandırıyor.",
    "localCheck.length": "Uzunluk uygun. Ana noktayı net bir şekilde iletin.",
    "localCheck.specific": "Somut bir deneyim veya örnek içeriyor, bu da ikna edici.",
    "localCheck.risky": "Yalnızca faydaları, parayı veya yükümlülüklerden kaçınmayı vurgulayan ifadelerden kaçınmak daha güvenlidir.",
    "localCheck.okStart": "Soruya net bir yanıt verdiniz.",
    "rubric.title": "Yanıt değerlendirme ölçütleri",
    "rubric.direct": "Doğrudan yanıt",
    "rubric.specific": "Somut örnek",
    "rubric.structure": "Neden ve yapı",
    "rubric.length": "Yeterli uzunluk",
    "rubric.attitude": "Güvenli ifade",
    "rubric.ok": "Yeterli",
    "rubric.improve": "Geliştir",
    "cautionCoach": "Bu geri bildirim alıştırma amaçlıdır ve herhangi bir inceleme sonucunu garanti etmez."
  },
  uk: {
    "hero.kicker": "Послуги з громадянства та підготовка до співбесіди",
    "hero.title": "Послуги з громадянства та підготовка до співбесіди з натуралізації в одному місці",
    "hero.lead": "Натуралізація, відновлення громадянства, втрата/відмова, множинне громадянство, присяга громадянина та підготовка до співбесіди — перегляньте процес, близький до вашої ситуації, на основі офіційного законодавства та настанов, а потім потренуйтеся за допомогою запитань і пробної співбесіди.",
    "hero.ctaPrimary": "Почати підготовку до співбесіди",
    "hero.ctaSecondary": "Переглянути послуги з громадянства",
    "global.disclaimer": "Ця функція — навчальний інструмент, який допомагає перевірити послуги з громадянства та підготуватися до співбесіди з натуралізації та оцінювання базових знань, і не гарантує жодного результату розгляду. Завжди звіряйте офіційні настанови та індивідуальні повідомлення з Міністерством юстиції / імміграційним офісом.",
    "about.title": "Ознайомтеся з послугами з громадянства",
    "about.intro": "Виберіть тип послуги, щоб побачити, що це таке, для кого вона зазвичай призначена, типовий процес, застереження щодо документів, пов'язані закони та офіційні джерела. Окремі випадки можуть відрізнятися.",
    "laws.title": "Пов'язані закони та настанови",
    "laws.intro": "Перегляньте офіційні джерела, що лежать в основі роботи з громадянством, за типами. Місцеві оголошення та допоміжні пояснення позначаються окремо. Відкривайте зовнішні посилання, щоб прочитати оригінали.",
    "flow.title": "Процедура та документообіг",
    "flow.intro": "Виберіть тип, щоб побачити загальний процес та застереження щодо документів. Точний порядок, документи та критерії визначаються компетентним імміграційним офісом і можуть відрізнятися залежно від випадку.",
    "interview.title": "Навчальна кімната для співбесіди з натуралізації",
    "interview.intro": "Готуйтеся крок за кроком: зрозумійте процес, вивчіть основні теми, перегляньте тренувальні запитання, проведіть пробну співбесіду та перегляньте довідкові відео. Кожне запитання — це навчальний матеріал, а не реальне чи офіційне минуле запитання.",
    "kiip.title": "Навчальний процес попереднього / комплексного оцінювання",
    "kiip.intro": "Програма соціальної інтеграції (KIIP) призначає рівень через попереднє оцінювання, потім через порівневе навчання веде до комплексного оцінювання (включно з версією для натуралізації). Завершення програми саме по собі не означає схвалення натуралізації.",
    "videos.title": "Довідкові відео / матеріали",
    "videos.intro": "Надані користувачами плейлисти та канали впорядковані лише для довідки. Субтитри чи транскрипції не зберігаються, і це не офіційні матеріали.",
    "waymaker.title": "Waymaker коуч з громадянства",
    "waymaker.heading": "Запитуйте та практикуйтеся",
    "waymaker.desc": "Коуч-провідник з громадянства пояснює, розрізняючи закон і настанови; коуч зі співбесіди перевіряє надрукований вами відповідь і пропонує природніший приклад та додаткове запитання. Працює насамперед з текстом, без голосу.",
    "waymaker.note": "Він не прогнозує складання/провал; індивідуальні повідомлення та настанови імміграційного офісу завжди мають пріоритет.",
    "waymaker.ctaGuide": "Відкрити коуча-провідника з громадянства",
    "waymaker.ctaInterview": "Пробна співбесіда з коучем",
    "badge.official": "На основі офіційних джерел",
    "badge.notOfficial": "Не офіційне минуле запитання",
    "badge.unofficialVideo": "Неофіційне джерело",
    "footer.note": "New Home by Paradiso не пов'язаний і не входить до складу жодного офіційного органу. Усі настанови призначені для навчальної довідки; остаточне підтвердження отримуйте через Міністерство юстиції, імміграційний офіс, HiKorea або 1345.",
    "footer.back": "← Назад на головну сторінку громадянства та натуралізації",
    "filter.all": "Усі",
    "who": "Для кого це",
    "flowLabel": "Загальний процес",
    "docNote": "Застереження щодо документів",
    "relatedLaws": "Пов'язані закони",
    "relatedSources": "Офіційні джерела",
    "caution": "Увага",
    "confirmNeeded": "Потребує підтвердження",
    "caseVaries": "Може відрізнятися залежно від випадку",
    "viewFlow": "Переглянути процес відповіді",
    "guidance": "Настанови щодо відповіді",
    "goodStructure": "Хороша структура відповіді",
    "riskyPatterns": "Шаблони, яких слід уникати",
    "practiceWaymaker": "Практикуйтеся з Waymaker",
    "rooms.understand": "Зрозуміти процес",
    "rooms.topics": "Основні теми",
    "rooms.questions": "Тренувальні запитання",
    "rooms.mock": "Пробна співбесіда",
    "rooms.videos": "Довідкові відео",
    "randomQ": "Випадкове запитання",
    "searchQ": "Пошук запитань",
    "allCats": "Усі теми",
    "allDiffs": "Усі рівні",
    "mock.todayQ": "Сьогоднішнє тренувальне запитання",
    "mock.next": "Наступне запитання",
    "mock.placeholder": "Введіть свою відповідь тут. Додавання причини та прикладу допомагає.",
    "mock.checkLocal": "Перевірити мою відповідь",
    "mock.startWaymaker": "Почати пробну співбесіду Waymaker",
    "mock.retry": "Переписати відповідь",
    "mock.strengths": "Сильні сторони",
    "mock.improvements": "Що покращити",
    "mock.risky": "Вислови, на які варто звернути увагу",
    "mock.revised": "Природніший приклад відповіді",
    "mock.followup": "Наступне тренувальне запитання",
    "mock.tip": "Порада для навчання",
    "mock.loading": "Waymaker переглядає вашу відповідь…",
    "mock.aiFail": "Не вдалося завантажити відгук AI. Будь ласка, спочатку перевірте базові результати.",
    "mock.localTitle": "Базова перевірка (офлайн)",
    "mock.noAnswer": "Будь ласка, спочатку введіть відповідь.",
    "understand.heading": "Як поєднуються підготовка до співбесіди та базових знань?",
    "understand.body": "Підготовка до натуралізації зазвичай поєднує навчання за Програмою соціальної інтеграції (KIIP), попереднє/комплексне оцінювання та співбесіду в межах розгляду натуралізації. Співбесіда перевіряє базові знання та комунікацію, а не завчені відповіді.",
    "understand.warn": "Кого запрошують на співбесіду, її зміст та будь-які звільнення залежать від конкретного випадку та повідомлення. Це лише навчальна довідка; ваше індивідуальне повідомлення та компетентний імміграційний офіс завжди мають пріоритет.",
    "understand.steps": "Приклад процесу підготовки",
    "sourceLabel.official_kiip": "Пов'язано з KIIP",
    "sourceLabel.official_socinet": "Пов'язано з оцінюванням",
    "sourceLabel.practice": "Практика",
    "sourceLabel.internal_guidance": "Настанови щодо поведінки",
    "sourceLabel.official_law": "Посилання на закон",
    "sourceLabel.official_notice": "Посилання на офіційне повідомлення",
    "sourceLabel.video_reference_topic": "Тема відео",
    "studyFocus": "Фокус навчання",
    "noResults": "Немає відповідних результатів.",
    "videoDisclaimer": "Відеоматеріали є неофіційними джерелами й не є реальними запитаннями зі співбесіди чи офіційними минулими запитаннями Міністерства юстиції.",
    "openLink": "Відкрити",
    "difficulty.easy": "Легко",
    "difficulty.medium": "Середньо",
    "difficulty.hard": "Складно",
    "localCheck.tooShort": "Ваша відповідь дуже коротка. Спробуйте додати по одному реченню для причини та конкретного досвіду.",
    "localCheck.direct": "Стабільніше, коли пряма відповідь на запитання йде першою.",
    "localCheck.vague": "Звучить трохи розпливчасто. Додайте один конкретний приклад або досвід.",
    "localCheck.structure": "Причина та приклад надають вашій відповіді хорошу структуру.",
    "localCheck.length": "Довжина відповідна. Чітко донесіть головну думку.",
    "localCheck.specific": "Містить конкретний досвід або приклад, що є переконливим.",
    "localCheck.risky": "Безпечніше уникати наголошення лише на вигодах, грошах чи ухиленні від обов'язків.",
    "localCheck.okStart": "Ви дали чітку відповідь на запитання.",
    "rubric.title": "Критерії оцінки відповіді",
    "rubric.direct": "Пряма відповідь",
    "rubric.specific": "Конкретний приклад",
    "rubric.structure": "Причина та структура",
    "rubric.length": "Достатня довжина",
    "rubric.attitude": "Безпечне формулювання",
    "rubric.ok": "Достатньо",
    "rubric.improve": "Покращити",
    "cautionCoach": "Цей відгук призначений для практики й не гарантує жодного результату розгляду."
  }
};
  ...
  var CATEGORY_LABELS = {
    ...
    reason_for_naturalization: { ko: '귀화 동기', en: 'Reason for naturalization', 'zh-CN': '归化动机', ja: '帰化の動機', vi: 'Lý do nhập tịch', tl: 'Dahilan ng naturalisasyon', id: 'Alasan naturalisasi', ru: 'Причина натурализации', fr: 'Motif de la naturalisation', es: 'Motivo de la naturalización', ar: 'دافع التجنّس', de: 'Grund der Einbürgerung', tr: "Vatandaşlığa geçiş nedeni", uk: "Причина натуралізації" },
    life_in_korea: { ko: '한국 생활 경험', en: 'Life in Korea', 'zh-CN': '韩国生活经历', ja: '韓国での生活経験', vi: 'Cuộc sống ở Hàn Quốc', tl: 'Buhay sa Korea', id: 'Kehidupan di Korea', ru: 'Жизнь в Корее', fr: 'Vie en Corée', es: 'Vida en Corea', ar: 'الحياة في كوريا', de: 'Leben in Korea', tr: "Kore'de yaşam", uk: "Життя в Кореї" },
    korean_society: { ko: '대한민국 사회 기본 이해', en: 'Korean society', 'zh-CN': '韩国社会基本了解', ja: '韓国社会の基本理解', vi: 'Xã hội Hàn Quốc', tl: 'Lipunang Korean', id: 'Masyarakat Korea', ru: 'Корейское общество', fr: 'Société coréenne', es: 'Sociedad coreana', ar: 'المجتمع الكوري', de: 'Koreanische Gesellschaft', tr: "Kore toplumu", uk: "Корейське суспільство" },
    democratic_order: { ko: '자유민주적 기본질서', en: 'Democratic order', 'zh-CN': '自由民主基本秩序', ja: '自由民主的基本秩序', vi: 'Trật tự dân chủ tự do', tl: 'Demokratikong kaayusan', id: 'Tatanan demokratis', ru: 'Демократический порядок', fr: 'Ordre démocratique', es: 'Orden democrático', ar: 'النظام الديمقراطي الأساسي', de: 'Demokratische Grundordnung', tr: "Demokratik düzen", uk: "Демократичний устрій" },
    rights_and_duties: { ko: '권리와 의무', en: 'Rights & duties', 'zh-CN': '权利与义务', ja: '権利と義務', vi: 'Quyền và nghĩa vụ', tl: 'Mga karapatan at tungkulin', id: 'Hak dan kewajiban', ru: 'Права и обязанности', fr: 'Droits et devoirs', es: 'Derechos y deberes', ar: 'الحقوق والواجبات', de: 'Rechte und Pflichten', tr: "Haklar ve görevler", uk: "Права та обовʼязки" },
    interview_attitude: { ko: '면접 태도', en: 'Interview attitude', 'zh-CN': '面试态度', ja: '面接の態度', vi: 'Thái độ phỏng vấn', tl: 'Saloobin sa interbyu', id: 'Sikap wawancara', ru: 'Поведение на собеседовании', fr: 'Attitude en entretien', es: 'Actitud en la entrevista', ar: 'سلوك المقابلة', de: 'Verhalten im Interview', tr: "Mülakat tutumu", uk: "Поведінка на співбесіді" },
    pre_evaluation_study: { ko: '사전평가/종합평가', en: 'Pre/comprehensive evaluation', 'zh-CN': '事前评价/综合评价', ja: '事前評価/総合評価', vi: 'Đánh giá sơ bộ/tổng hợp', tl: 'Paunang/komprehensibong pagtatasa', id: 'Pra/evaluasi komprehensif', ru: 'Предварительная/комплексная оценка', fr: 'Évaluation préalable/complète', es: 'Evaluación previa/integral', ar: 'التقييم المسبق/الشامل', de: 'Vorab-/Gesamtbewertung', tr: "Ön/kapsamlı değerlendirme", uk: "Попереднє/комплексне оцінювання" }
  };
