 ...
 *  - Strings are trilingual (ko/en/zh-CN) in-module, so this new surface does
 *    not touch the central i18n packs (no parity-check risk) and does not
 *    regress Korean/English. Official procedure labels still come from the
 *    page's own txAt('procedureLabels', …) so they match everywhere.
 * ========================================================================= */
(function () {
  'use strict';
  ...
  /* ----------------------------------------------------- trilingual strings */
  var STR = {
    flowAria: { ko: '체류자격 절차 안내', en: 'Status procedure guide', 'zh-CN': '居留资格手续向导' },
    close: { ko: '닫기', en: 'Close', 'zh-CN': '关闭' },
    back: { ko: '← 이전', en: '← Back', 'zh-CN': '← 上一步' },
    seeResult: { ko: '결과 보기', en: 'See result', 'zh-CN': '查看结果' },
    unsure: { ko: '잘 모르겠어요', en: "I'm not sure", 'zh-CN': '我不太确定' },
    unsureHint: { ko: '몇 가지 질문으로 찾아보기', en: 'Find it with a few questions', 'zh-CN': '通过几个问题来查找' },
    yes: { ko: '예', en: 'Yes', 'zh-CN': '是' },
    no: { ko: '아니요', en: 'No', 'zh-CN': '否' },

    subcodeTitle: { ko: '{code} {name} 중 어떤 상황에 가까우신가요?', en: 'Which {code} {name} situation fits you?', 'zh-CN': '在 {code} {name} 中，哪种情况更接近您？' },
    subcodeIntro: { ko: '해당하는 세부 자격(세부코드)을 고르면 그에 맞는 절차 안내로 이동합니다.', en: 'Pick the sub-status that fits you to jump to the matching procedure guidance.', 'zh-CN': '选择适合您的细分资格（子代码），即可进入对应的手续指引。' },
    procTitle: { ko: '{label} · 어떤 절차가 필요하세요?', en: '{label} · Which procedure do you need?', 'zh-CN': '{label} · 您需要办理哪项手续？' },
    procIntro: { ko: '진행하려는 절차를 선택하면 해당 안내가 바로 열립니다.', en: 'Choose a procedure to open its guidance directly.', 'zh-CN': '选择要办理的手续，将直接打开相应指引。' },
    allProcedures: { ko: '먼저 전체 안내 보기', en: 'See the full guide first', 'zh-CN': '先查看完整指引' },

    badgeSubcode: { ko: '세부코드', en: 'Sub-code', 'zh-CN': '子代码' },
    badgeSituation: { ko: '상황별 선택', en: 'By situation', 'zh-CN': '按情况选择' },
    badgeSourceLimited: { ko: '공식 출처 보강 필요', en: 'Source coverage limited', 'zh-CN': '官方依据有限' },
    badgeNeedsReview: { ko: '수동 검토 필요', en: 'Needs manual review', 'zh-CN': '需人工核对' },

    statusAvailable: { ko: '안내 있음', en: 'Guidance available', 'zh-CN': '有指引' },
    statusConditional: { ko: '조건부', en: 'Conditional', 'zh-CN': '有条件' },
    statusNotApplicable: { ko: '해당 없음', en: 'Not applicable', 'zh-CN': '不适用' },
    statusSourceLimited: { ko: '공식 출처 확인 필요', en: 'Verify with official source', 'zh-CN': '需核对官方依据' },

    // user-facing procedure labels (generic, navigational — not legal content)
    procUser_visaIssuance: { ko: '해외에서 처음 비자 받기', en: 'Get the visa from abroad', 'zh-CN': '在海外首次申请签证' },
    procUser_certificateOfVisaIssuance: { ko: '초청자가 사증발급인정서 받기', en: 'Sponsor gets a certificate for visa issuance', 'zh-CN': '邀请方申请签证发放认定书' },
    procUser_statusChange: { ko: '한국 안에서 이 자격으로 바꾸기', en: 'Change to this status inside Korea', 'zh-CN': '在韩国境内变更为该资格' },
    procUser_extension: { ko: '이미 받은 자격의 기간 늘리기', en: 'Extend the period of this status', 'zh-CN': '延长已持有资格的期限' },
    procUser_statusGrant: { ko: '국내 출생 등으로 체류자격 부여받기', en: 'Be granted status (e.g. birth in Korea)', 'zh-CN': '获得居留资格（如在韩出生）' },
    procUser_registration: { ko: '입국 후 외국인등록 하기', en: 'Register as a foreign resident after entry', 'zh-CN': '入境后办理外国人登录' },
    procUser_activitiesOutsideStatus: { ko: '원래 자격 외 다른 활동 허가받기', en: 'Get permission for activities outside your status', 'zh-CN': '申请从事资格外活动的许可' },
    procUser_workplaceChange: { ko: '근무처(직장) 변경·추가 신고하기', en: 'Report a change/addition of workplace', 'zh-CN': '申报变更/增加工作单位' },
    procUser_reentry: { ko: '출국 후 다시 입국하기', en: 'Re-enter after leaving Korea', 'zh-CN': '出境后再次入境' },
    procUser_visitReservation: { ko: '방문예약·관할 관서 확인하기', en: 'Book a visit / check the competent office', 'zh-CN': '预约访问 / 确认管辖机关' },

    procExplain_visaIssuance: { ko: '재외공관 또는 사증발급인정서를 통한 최초 사증 발급 절차입니다.', en: 'First-time visa issuance via a consulate or a certificate for visa issuance.', 'zh-CN': '通过驻外使领馆或认定书的首次签证发放手续。' },
    procExplain_certificateOfVisaIssuance: { ko: '국내 초청자가 출입국·외국인관서에서 인정서를 신청하는 절차입니다.', en: 'A domestic sponsor applies for the certificate at an immigration office.', 'zh-CN': '由境内邀请方在出入境机关申请认定书的手续。' },
    procExplain_statusChange: { ko: '출국하지 않고 국내에서 다른 체류자격으로 변경하는 절차입니다.', en: 'Switch to another status inside Korea without leaving.', 'zh-CN': '无需出境，在韩国境内变更为其他居留资格。' },
    procExplain_extension: { ko: '현재 체류자격의 체류기간을 연장하는 절차입니다.', en: 'Extend the stay period of your current status.', 'zh-CN': '延长当前居留资格的停留期限。' },
    procExplain_statusGrant: { ko: '국내 출생 등으로 새로 체류자격을 부여받는 절차입니다.', en: 'Be newly granted a status, e.g. for a child born in Korea.', 'zh-CN': '因在韩出生等情形新获得居留资格。' },
    procExplain_registration: { ko: '90일 초과 체류 시 외국인등록증을 발급받는 절차입니다.', en: 'Get a registration card when staying over 90 days.', 'zh-CN': '停留超过90天时办理外国人登录证。' },
    procExplain_activitiesOutsideStatus: { ko: '현재 자격으로 허용되지 않는 활동을 허가받는 절차입니다.', en: 'Permission to do activities your status does not allow.', 'zh-CN': '申请从事当前资格不允许活动的许可。' },
    procExplain_workplaceChange: { ko: '근무처를 변경하거나 추가할 때 신고·허가하는 절차입니다.', en: 'Report or get permission when changing/adding a workplace.', 'zh-CN': '变更或增加工作单位时的申报/许可手续。' },
    procExplain_reentry: { ko: '체류 중 출국 후 같은 자격으로 다시 입국하기 위한 절차입니다.', en: 'Re-enter with the same status after a trip abroad.', 'zh-CN': '在停留期间出境后以同一资格再次入境。' },
    procExplain_visitReservation: { ko: '하이코리아 방문예약과 관할 출입국·외국인관서 확인을 도와드립니다.', en: 'Helps with HiKorea booking and finding the competent office.', 'zh-CN': '协助进行 HiKorea 预约并确认管辖机关。' },

    summaryEyebrow: { ko: '선택한 안내', en: 'Your selection', 'zh-CN': '您的选择' },
    summaryProcedurePrefix: { ko: '현재 선택한 절차', en: 'Selected procedure', 'zh-CN': '当前选择的手续' },
    summaryWho: { ko: '이 절차는 누구에게 해당하나요?', en: 'Who is this procedure for?', 'zh-CN': '该手续适用于谁？' },
    summaryWhoParent: { ko: '아래에서 세부코드를 고르면 더 정확한 안내를 받을 수 있습니다.', en: 'Pick a sub-code below for more specific guidance.', 'zh-CN': '在下方选择子代码可获得更精确的指引。' },
    changeSubcode: { ko: '세부코드 바꾸기', en: 'Change sub-code', 'zh-CN': '更改子代码' },
    changeProcedure: { ko: '절차 바꾸기', en: 'Change procedure', 'zh-CN': '更改手续' },
    sourceBtn: { ko: '공식근거 보기', en: 'Official basis', 'zh-CN': '官方依据' },
    waymakerBtn: { ko: 'Waymaker로 질문하기', en: 'Ask Waymaker', 'zh-CN': '向 Waymaker 提问' },
    summaryNoSubcode: { ko: '세부코드 미지정 · 대표 안내', en: 'No sub-code · general guidance', 'zh-CN': '未指定子代码 · 通用指引' },
    summaryProcedureMissing: { ko: '이 자격에는 ‘{label}’ 절차의 출처 기반 안내가 아직 정리되어 있지 않습니다. 하이코리아(1345)·관할 출입국·외국인관서 또는 공식 매뉴얼에서 확인하세요.', en: "Source-backed guidance for the '{label}' procedure is not yet available for this status. Please verify via HiKorea (1345), the competent immigration office, or the official manual.", 'zh-CN': '该资格的“{label}”手续暂无基于官方依据的指引。请通过 HiKorea（1345）、管辖出入境机关或官方手册核实。' },

    finderResultTitle: { ko: '이 상황에 가까워 보여요', en: 'This looks closest', 'zh-CN': '看起来最接近这种情况' },
    finderResultLead: { ko: '맞다면 절차 선택으로 이동하세요. 자격·허가 여부는 보장하지 않습니다.', en: 'If correct, continue to procedure selection. This does not guarantee eligibility.', 'zh-CN': '如无误，请继续选择手续。本指引不保证资格或许可。' },
    finderLowTitle: { ko: '공식기관 확인이 필요한 상황입니다', en: 'Official confirmation is recommended', 'zh-CN': '建议向官方机关确认' },
    finderLowLead: { ko: '정확히 판단하기 어려워, 아래 가까운 세부코드를 참고하시고 관할 출입국·외국인관서나 하이코리아(1345)에서 최종 확인하세요.', en: 'It is hard to determine precisely. Consider the closest sub-codes below and confirm with the competent immigration office or HiKorea (1345).', 'zh-CN': '难以精确判断。请参考下方最接近的子代码，并向管辖出入境机关或 HiKorea（1345）最终确认。' },
    finderPickManually: { ko: '세부코드 직접 고르기', en: 'Choose a sub-code myself', 'zh-CN': '自行选择子代码' },

    cardCtaSubcoded: { ko: '상황·절차별로 안내받기', en: 'Guide me by situation & procedure', 'zh-CN': '按情况和手续获取指引' },
    cardCtaPlain: { ko: '절차별로 안내받기', en: 'Guide me by procedure', 'zh-CN': '按手续获取指引' },
    cardCtaHint: { ko: '세부코드와 절차를 골라 바로 안내로 이동', en: 'Pick a sub-code and procedure to jump straight to guidance', 'zh-CN': '选择子代码与手续即可直达指引' },
    invalidNotice: { ko: '요청하신 세부코드/절차를 찾을 수 없어 상위 자격 안내로 이동했습니다.', en: 'The requested sub-code/procedure was not found; showing the parent status instead.', 'zh-CN': '未找到所请求的子代码/手续，已转为显示上级资格指引。' },
    errNoRecord: { ko: '해당 체류자격 정보를 찾을 수 없습니다.', en: 'Could not find this status.', 'zh-CN': '未找到该居留资格信息。' },
    sourceLimitedNote: { ko: '이 자격은 출처 기반 안내가 제한적입니다. 표시되지 않는 절차는 공식 매뉴얼·하이코리아에서 확인하세요.', en: 'Source-backed guidance is limited for this status. Verify procedures not shown via the official manual or HiKorea.', 'zh-CN': '该资格的官方依据指引有限。未显示的手续请通过官方手册或 HiKorea 核实。' }
  };
  ...
  var SUBCODE_USER_LABEL = {
    'F-6-1': { ko: '한국 국민과 혼인 중인 외국인 배우자', en: 'Foreign spouse currently married to a Korean national', 'zh-CN': '与韩国国民处于婚姻关系中的外籍配偶' },
    'F-6-2': { ko: '한국 국민과의 사이에서 태어난 자녀를 양육하는 경우', en: 'Raising a child born with a Korean national', 'zh-CN': '抚养与韩国国民所生子女的情形' },
    'F-6-3': { ko: '배우자 사망·실종·이혼 등으로 혼인관계가 단절된 경우', en: 'Marriage ended by spouse death, disappearance, or divorce', 'zh-CN': '因配偶死亡、失踪、离婚等导致婚姻关系终止的情形' }
  };
  ...
  var ROUTE_FINDER = {
    'F-6': {
      ...
      questions: {
        q1: {
          text: { ko: '한국 국민과 현재 혼인 중이신가요?', en: 'Are you currently married to a Korean national?', 'zh-CN': '您目前与韩国国民处于婚姻关系中吗？' },
          options: [
        ...
        q2: {
          text: { ko: '한국 국민과의 사이에서 태어난 자녀를 양육 중이신가요?', en: 'Are you raising a child born with a Korean national?', 'zh-CN': '您是否在抚养与韩国国民所生的子女？' },
          options: [
        ...
        q3: {
          text: { ko: '배우자의 사망·실종·이혼 등으로 혼인관계가 종료되었나요?', en: "Did the marriage end through the spouse's death, disappearance, or divorce?", 'zh-CN': '婚姻关系是否因配偶死亡、失踪、离婚等而终止？' },
          options: [
