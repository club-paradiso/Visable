...
(function () {
  ...
  function injectStyles() {
    ...
    var css = ''
      ...
      + '.lss-root{margin:1.25rem auto 0;padding:0 1rem;line-height:1.65;}'
      + '.lss-panel{border-radius:14px;}'
      + '.lss-head{min-height:86px;padding:1rem;gap:.45rem .6rem;}'
      + '.lss-head-main{gap:.45rem;min-width:0;}'
      + '.lss-head-title{font-size:1rem;line-height:1.4;letter-spacing:-.01em;}'
      + '.lss-ref-chip{min-height:24px;display:inline-flex;align-items:center;font-size:.68rem;line-height:1.25;}'
      + '.lss-head-sub{font-size:.84rem;line-height:1.58;word-break:keep-all;}'
      + '.lss-body{padding:0 1rem 1rem;}'
      + '.lss-disclaimer{padding:.85rem .9rem;font-size:.82rem;line-height:1.62;word-break:keep-all;}'
      + '.lss-tabs{gap:.45rem;margin-bottom:.8rem;overflow-x:auto;scrollbar-width:none;}'
      + '.lss-tab{min-height:44px;padding:.45rem .9rem;font-size:.86rem;line-height:1.3;}'
      + '.lss-searchbar{gap:.55rem;margin-bottom:.8rem;}'
      + '.lss-input,.lss-search-btn{min-height:50px;line-height:1.4;}'
      + '.lss-search-btn{padding:0 1rem;font-size:.9rem;font-weight:800;}'
      + '.lss-chips{gap:.45rem;margin-bottom:1rem;}'
      + '.lss-chip{min-height:44px;padding:.45rem .75rem;font-size:.84rem;line-height:1.4;}'
      + '.lss-depth-label,.lss-examples-label{font-size:.76rem;line-height:1.4;}'
      + '.lss-depth-btn{min-height:46px;padding:.5rem .7rem;font-size:.86rem;line-height:1.35;}'
      ...
      + '.lss-card-sub,.lss-snip,.lss-rnote,.lss-rlist li{line-height:1.65;}'
      + '.lss-src{min-height:44px;line-height:1.4;}'
      + '}'
