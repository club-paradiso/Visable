...
(function () {
  ...
  var F4_SUPPORTED_LANGS = { en: 1, 'zh-CN': 1, ja: 1, vi: 1, tl: 1, id: 1, ru: 1, fr: 1, es: 1, ar: 1, de: 1, tr: 1, uk: 1 };
  function f4Lang() {
  ...
  var STR_TR = {
    "loading": "F-4 rehber verileri yükleniyor…",
    "fetchFail": "F-4 rehber verileri yüklenemedi. Bunlar olmadan devam etmeyin — lütfen doğrudan yetkili Kore temsilciliğiniz, HiKorea veya 1345 ile doğrulayın.",
    "entryEyebrow": "Yurt dışı Koreli F-4 · Resmi kaynaklara dayalı rehber",
    "startCtaFallback": "F-4 prosedürlerini kontrol edin",
    "modalAria": "F-4 yurt dışı Koreli rehberi",
    "close": "Kapat",
    "back": "← Geri",
    "restart": "Baştan başla",
    "seeResult": "Sonucu gör",
    "recommended": "Önerilen yol",
    "why": "Neden bu yol?",
    "checkFirst": "Önce kontrol edin",
    "nextStep": "Sonraki adım",
    "cautions": "Uyarılar",
    "officialWarn": "Resmi doğrulama bildirimi",
    "countryGuide": "Ülkeye özel kontrol",
    "openHub": "F-4 prosedürlerini ayrıntılı görüntüle",
    "backToDiagnostic": "← Tanıya geri dön",
    "hubTitle": "F-4 prosedür rehberi merkezi",
    "selectCountryLabel": "Başvuru veya ikamet ülkenizi seçin",
    "selectCountryHint": "Konsolosluk prosedürleri, sabıka kaydı belgeleri, kimlik doğrulama yöntemleri, randevu, ücretler ve işlem süreleri ülkeye göre değişebilir. Doğrulanmamış ülkeler için yalnızca ortak F-4 standartları gösterilir.",
    "selectCountryPlaceholder": "— Bir ülke seçin (isteğe bağlı) —",
    "noCountrySelected": "Henüz bir ülke seçilmedi. Yalnızca ortak F-4 standartları gösteriliyor. O ülkenin konsolosluk rehberini de görmek için bir ülke seçin (doğrulanmış olduğu yerlerde).",
    "commonRulesHeading": "Ortak F-4 standartları (tüm ülkeler)",
    "countryRulesHeading": "Ülkeye özel rehber",
    "docsHeading": "Ortak gerekli belgeler",
    "stepsHeading": "Adımlar",
    "sourcesHeading": "Kaynaklar",
    "notGuaranteeFootnote": "Bu rehber uygunluğu veya onayı garanti etmez. Gerçek uygulamayı yetkili Kore temsilciliğiniz, göçmenlik ofisi veya HiKorea (1345) ile teyit edin.",
    "badgeVerified": "Resmi standart doğrulandı",
    "badgePartial": "Kısmi resmi kaynaklar",
    "badgeRefresh": "Resmi güncelliği doğrulayın",
    "badgeOfficialCheck": "Resmi kontrol gerekli",
    "badgeUnclear": "Doğrulama kaynağı yok",
    "sourceDatePrefix": "İtibarıyla",
    "linkMissionPage": "Temsilcilik bilgi sayfası",
    "linkMissionFinder": "Kore temsilciliğinizi bulun",
    "linkVisaPortal": "Vize Portalını kontrol edin",
    "linkHikorea": "HiKorea'da kontrol edin",
    "link1345": "1345 üzerinden doğrulayın",
    "tagCountryVaries": "Ülkeye göre değişir",
    "tagOfficialCheck": "Resmi kontrol",
    "answerPrompt": "Önerilen yolunuzu görmek için yukarıdaki soruları yanıtlayın.",
    "ctaHelperFallback": "Konsolosluk başvurusu, yurt içi ikamet bildirimi ve statü değişikliği arasından size uygun akışı bulun.",
    "conditionsHeading": "Koşullar",
    "fieldCriminalRecord": "Sabıka kaydı belgesi",
    "fieldAuthentication": "Belge kimlik doğrulaması (apostil / konsolosluk)",
    "fieldBooking": "Randevu",
    "fieldFee": "Ücretler (vize ücreti)",
    "fieldProcessingTime": "İşlem süresi",
    "fieldMissionPractice": "Temsilcilik uygulaması",
    "guideHeader": "F-4 Yurt Dışı Koreli İkamet Statüsü Rehberi",
    "guideIntro": "Gerekli belgeler ve prosedürler, yurt dışı Koreli kategorinize, vatandaşlık geçmişinize ve başvuru yolunuza göre değişebilir. Durumunuza en yakın hazırlık yolunu bulmak için birkaç soruyu yanıtlayın.",
    "primaryCta": "F-4 Belge Kontrol Listemi Bul",
    "recStartTitle": "Durumunuza uygun rehberli adımlar",
    "recStartBody": "F-4 belgeleri ve prosedürleri, vatandaşlık geçmişine, başvuru yerine ve ikamet kaydı ihtiyaçlarına göre değişebilir. Alt kategorinizi bilmeseniz bile, durumunuza en yakın belge kontrol listesini ve prosedürü bulmak için birkaç soruyu yanıtlayın.",
    "ctaMicrocopy": "Yaklaşık 1 dakika · 4–5 soru · Alt kategori bilgisi gerekmez",
    "stickyCta": "F-4 Kontrol Listesini Başlat",
    ...
    "backToGuide": "← Rehbere geri dön",
    "startGuideShort": "Rehberi başlat",
    "progressAria": "İlerleme",
    "stepSituationQ": "Hangi durum sizinkine en yakın?",
    "stepNationalityQ": "Sizin veya ailenizin Kore vatandaşlığı geçmişi var mı?",
    "stepLocationQ": "Şu anda nerede bulunuyorsunuz?",
    "stepProcedureQ": "Şu anda hangi prosedüre ihtiyacınız var?",
    "stepConfirmQ": "Ek doğrulama gerektirebilecek öğeler",
    "stepConfirmHelp": "Aşağıdaki öğeler, bireysel durumunuza bağlı olarak ek doğrulama gerektirebilir. Geçerli olanları seçin, sonucunuzda görünecekler. Bu adım isteğe bağlıdır.",
    "optUnsure": "Emin değilim",
    "optSitApplyAbroad": "Kore dışından F-4 vizesi için başvurmak istiyorum",
    "optSitChangeInKorea": "Kore içinde statümü F-4'e değiştirmek istiyorum",
    "optSitExtension": "Zaten F-4'üm var ve uzatma/değişiklik rehberi gerekiyor",
    "optSitResidence": "Yurt içi ikamet kaydı rehberine ihtiyacım var",
    "optNatSelfHeld": "Daha önce Kore vatandaşlığına sahiptim",
    "optNatAncestor": "Anne-babam veya büyükanne-büyükbabam daha önce Kore vatandaşlığına sahipti",
    "optNatNone": "Geçerli değil",
    "optLocInKorea": "Şu anda Kore'deyim",
    "optLocOverseas": "Şu anda Kore dışındayım",
    "optProcVisa": "Vize düzenleme",
    "optProcChange": "Statü değişikliği",
    "optProcExtension": "İkamet süresi uzatma",
    "optProcResidence": "Yurt içi ikamet kaydı",
    "confNationalityLoss": "Vatandaşlık kaybı / feragati",
    "confFamilyProof": "Aile ilişkisi kanıtı",
    "confCriminalRecord": "Sabıka kaydı belgesi",
    "confMilitary": "Askerlik hizmetiyle ilgili konu",
    "confApostille": "Apostil / konsolosluk onayı",
    "confTranslation": "Çeviri / noter tasdiki",
    "mayRequireConfirm": "Ek doğrulama gerektirebilir",
    "officialSourceNeedsConfirm": "Resmi kaynak doğrulama gerektiriyor",
    "resultTitle": "Muhtemel F-4 hazırlık yolunuz",
    "resWhy": "Neden bu yol?",
    "resFirstSteps": "İlk adımlar",
    "resBasicDocs": "Temel gerekli belgeler",
    "resAdditionalDocs": "Durumunuz için eklenebilecek belgeler",
    "resProcedure": "Prosedür",
    "resSources": "Resmi kaynaklar",
    "resNextActions": "Sonraki işlemler",
    "checklistIntro": "Aşağıdaki belgeler, resmi kılavuzlardan derlenmiş referans niteliğinde bir kontrol listesidir. Hazırlanırken takip etmek için her öğeye dokunun.",
    "copyChecklist": "Kontrol listesini kopyala",
    "copied": "Kopyalandı",
    "copyFail": "Kopyalanamadı",
    "viewDocDetails": "Belge ayrıntılarını görüntüle",
    "viewHikoreaGuide": "HiKorea rezervasyon rehberini görüntüle",
    "checkJurisdiction": "Yetkili ofisi kontrol edin",
    "safetyNote": "Bireysel durumunuza ve yetkili göçmenlik ofisinin veya Kore konsolosluğunun kararına bağlı olarak ek belgeler istenebilir.",
    "routeLabelOverseas": "F-4 vize başvurusu inceleme yolu",
    "routeLabelStatusChange": "F-4 statü değişikliği inceleme yolu",
    "routeLabelExtension": "F-4 uzatma/değişiklik hazırlık yolu",
    "routeLabelResidence": "Yurt içi ikamet kaydı hazırlık yolu",
    "routeLabelOfficialCheck": "Resmi doğrulama gerektiren bir yol",
    "procStepPrepare": "Belgeleri hazırlayın",
    "procStepReserve": "Gerekirse randevu alın",
    "procStepSubmit": "Başvuruyu gönderin",
    "procStepReview": "İnceleme / değerlendirme",
    "procStepResult": "Sonucu kontrol edin",
    "procStepFollowup": "Gerekirse takip kaydını veya kart düzenlemesini tamamlayın",
    "noAdditionalDocsNote": "Herhangi bir ek öğe seçmediniz. Bireysel durumunuza bağlı olarak yine de ek belgeler istenebilir — yetkili ofisle teyit edin.",
    "extensionDocsNote": "Uzatma için gereken belirli belgeler, bireysel durumunuza ve yetkili ofise bağlıdır. Aşağıdaki rehberle birlikte yetkili göçmenlik ofisi veya HiKorea (1345) ile teyit edin.",
    "officialCheckDocsNote": "Uygunluğunuzun/vatandaşlığınızın önce çözülmesi gerektiğinden, burada kesin bir belge listesi belirtmiyoruz. Yetkili temsilciliğiniz veya Adalet Bakanlığı (HiKorea / 1345) ile teyit edin.",
    "subcatHeading": "F-4 alt kategorileri"
  };
  var STR_UK = {
    "loading": "Завантаження даних керівництва F-4…",
    "fetchFail": "Не вдалося завантажити дані керівництва F-4. Не продовжуйте без них — будь ласка, перевірте безпосередньо у компетентному корейському представництві, на HiKorea або за номером 1345.",
    "entryEyebrow": "Закордонний кореєць F-4 · Керівництво на основі офіційних джерел",
    "startCtaFallback": "Перевірити процедури F-4",
    "modalAria": "Керівництво для закордонних корейців F-4",
    "close": "Закрити",
    "back": "← Назад",
    "restart": "Почати спочатку",
    "seeResult": "Переглянути результат",
    "recommended": "Рекомендований шлях",
    "why": "Чому цей шлях?",
    "checkFirst": "Спочатку перевірте",
    "nextStep": "Наступний крок",
    "cautions": "Застереження",
    "officialWarn": "Повідомлення про офіційну перевірку",
    "countryGuide": "Перевірка для конкретної країни",
    "openHub": "Переглянути процедури F-4 докладно",
    "backToDiagnostic": "← Назад до діагностики",
    "hubTitle": "Центр керівництва процедурами F-4",
    "selectCountryLabel": "Виберіть країну подання заяви або проживання",
    "selectCountryHint": "Консульські процедури, довідки про несудимість, методи автентифікації, бронювання, збори та строки обробки можуть відрізнятися залежно від країни. Для неперевірених країн показано лише загальні стандарти F-4.",
    "selectCountryPlaceholder": "— Виберіть країну (необов'язково) —",
    "noCountrySelected": "Країну ще не вибрано. Показано лише загальні стандарти F-4. Виберіть країну, щоб також побачити консульське керівництво цієї країни (де перевірено).",
    "commonRulesHeading": "Загальні стандарти F-4 (усі країни)",
    "countryRulesHeading": "Керівництво для конкретної країни",
    "docsHeading": "Загальні необхідні документи",
    "stepsHeading": "Кроки",
    "sourcesHeading": "Джерела",
    "notGuaranteeFootnote": "Це керівництво не гарантує відповідність вимогам або схвалення. Підтвердіть фактичне застосування у компетентному корейському представництві, імміграційному офісі або на HiKorea (1345).",
    "badgeVerified": "Офіційний стандарт перевірено",
    "badgePartial": "Часткові офіційні джерела",
    "badgeRefresh": "Перевірте офіційну актуальність",
    "badgeOfficialCheck": "Потрібна офіційна перевірка",
    "badgeUnclear": "Немає джерел для перевірки",
    "sourceDatePrefix": "Станом на",
    "linkMissionPage": "Інформаційна сторінка представництва",
    "linkMissionFinder": "Знайдіть своє корейське представництво",
    "linkVisaPortal": "Перевірте Візовий портал",
    "linkHikorea": "Перевірте на HiKorea",
    "link1345": "Перевірте за номером 1345",
    "tagCountryVaries": "Залежить від країни",
    "tagOfficialCheck": "Офіційна перевірка",
    "answerPrompt": "Дайте відповіді на запитання вище, щоб побачити рекомендований шлях.",
    "ctaHelperFallback": "Знайдіть підхожий для вас процес серед консульського подання заяви, внутрішнього повідомлення про проживання та зміни статусу.",
    "conditionsHeading": "Умови",
    "fieldCriminalRecord": "Довідка про несудимість",
    "fieldAuthentication": "Автентифікація документів (апостиль / консульська)",
    "fieldBooking": "Бронювання",
    "fieldFee": "Збори (візовий збір)",
    "fieldProcessingTime": "Час обробки",
    "fieldMissionPractice": "Практика представництва",
    "guideHeader": "Керівництво зі статусу закордонного корейця F-4",
    "guideIntro": "Необхідні документи та процедури можуть відрізнятися залежно від вашої категорії закордонного корейця, історії громадянства та шляху подання заяви. Дайте відповіді на кілька запитань, щоб знайти шлях підготовки, найближчий до вашої ситуації.",
    "primaryCta": "Знайти мій контрольний список документів F-4",
    "recStartTitle": "Керовані кроки для вашої ситуації",
    "recStartBody": "Документи та процедури F-4 можуть відрізнятися залежно від історії громадянства, місця подання заяви та потреб у реєстрації проживання. Навіть якщо ви не знаєте своєї підкатегорії, дайте відповіді на кілька запитань, щоб знайти контрольний список документів і процедуру, найближчі до вашої ситуації.",
    "ctaMicrocopy": "Близько 1 хвилини · 4–5 запитань · Знання підкатегорії не потрібне",
    "stickyCta": "Розпочати контрольний список F-4",
    ...
    "stepWord": "Крок",
    "next": "Далі",
    "restartShort": "Перезапустити",
    "backToGuide": "← Назад до керівництва",
    "startGuideShort": "Розпочати керівництво",
    "progressAria": "Прогрес",
    "stepSituationQ": "Яка ситуація найближча до вашої?",
    "stepNationalityQ": "Чи маєте ви або ваша родина історію корейського громадянства?",
    "stepLocationQ": "Де ви зараз перебуваєте?",
    "stepProcedureQ": "Яка процедура вам потрібна зараз?",
    "stepConfirmQ": "Пункти, які можуть потребувати додаткового підтвердження",
    "stepConfirmHelp": "Пункти нижче можуть потребувати додаткового підтвердження залежно від вашого індивідуального випадку. Виберіть ті, що застосовні, і вони з'являться у вашому результаті. Цей крок є необов'язковим.",
    "optUnsure": "Я не впевнений",
    "optSitApplyAbroad": "Я хочу подати заяву на візу F-4 з-за меж Кореї",
    "optSitChangeInKorea": "Я хочу змінити свій статус на F-4 в межах Кореї",
    "optSitExtension": "Я вже маю F-4 і потребую керівництва щодо продовження/зміни",
    "optSitResidence": "Мені потрібне керівництво щодо внутрішньої реєстрації проживання",
    "optNatSelfHeld": "Раніше я мав корейське громадянство",
    "optNatAncestor": "Мій батько/мати або дідусь/бабуся раніше мали корейське громадянство",
    "optNatNone": "Не застосовно",
    "optLocInKorea": "Я зараз у Кореї",
    "optLocOverseas": "Я зараз за межами Кореї",
    "optProcVisa": "Видача візи",
    "optProcChange": "Зміна статусу",
    "optProcExtension": "Продовження перебування",
    "optProcResidence": "Внутрішня реєстрація проживання",
    "confNationalityLoss": "Втрата / відмова від громадянства",
    "confFamilyProof": "Підтвердження сімейних відносин",
    "confCriminalRecord": "Довідка про несудимість",
    "confMilitary": "Питання, пов'язане з військовою службою",
    "confApostille": "Апостиль / консульське підтвердження",
    "confTranslation": "Переклад / нотаріальне засвідчення",
    "mayRequireConfirm": "Може потребувати додаткового підтвердження",
    "officialSourceNeedsConfirm": "Офіційне джерело потребує підтвердження",
    "resultTitle": "Ваш ймовірний шлях підготовки F-4",
    "resWhy": "Чому цей шлях?",
    "resFirstSteps": "Перші кроки",
    "resBasicDocs": "Основні необхідні документи",
    "resAdditionalDocs": "Документи, які можуть бути додані для вашої ситуації",
    "resProcedure": "Процедура",
    "resSources": "Офіційні джерела",
    "resNextActions": "Наступні дії",
    "checklistIntro": "Документи нижче — це довідковий контрольний список, складений з офіційних посібників. Торкніться кожного пункту, щоб відстежувати його під час підготовки.",
    "copyChecklist": "Копіювати контрольний список",
    "copied": "Скопійовано",
    "copyFail": "Не вдалося скопіювати",
    "viewDocDetails": "Переглянути деталі документа",
    "viewHikoreaGuide": "Переглянути керівництво з бронювання HiKorea",
    "checkJurisdiction": "Перевірте компетентний офіс",
    "safetyNote": "Додаткові документи можуть бути запитані залежно від вашого індивідуального випадку та рішення компетентного імміграційного офісу або корейського консульства.",
    "routeLabelOverseas": "Шлях розгляду заяви на візу F-4",
    "routeLabelStatusChange": "Шлях розгляду зміни статусу F-4",
    "routeLabelExtension": "Шлях підготовки продовження/зміни F-4",
    "routeLabelResidence": "Шлях підготовки внутрішньої реєстрації проживання",
    "routeLabelOfficialCheck": "Шлях, що потребує офіційного підтвердження",
    "procStepPrepare": "Підготуйте документи",
    "procStepReserve": "Зробіть бронювання, якщо застосовно",
    "procStepSubmit": "Подайте заяву",
    "procStepReview": "Розгляд / перевірка",
    "procStepResult": "Перевірте результат",
    "procStepFollowup": "За потреби завершіть подальшу реєстрацію або видачу картки",
    "noAdditionalDocsNote": "Ви не вибрали жодних додаткових пунктів. Додаткові документи все одно можуть бути запитані залежно від вашого індивідуального випадку — підтвердіть у компетентному офісі.",
    "extensionDocsNote": "Конкретні документи для продовження залежать від вашого індивідуального випадку та компетентного офісу. Підтвердіть у компетентному імміграційному офісі або на HiKorea (1345) разом із керівництвом нижче.",
    "officialCheckDocsNote": "Оскільки вашу відповідність вимогам/громадянство слід вирішити першочергово, ми не наводимо тут остаточний перелік документів. Підтвердіть у своєму компетентному представництві або в Міністерстві юстиції (HiKorea / 1345).",
    "subcatHeading": "Підкатегорії F-4"
  };
  var STR_PACKS = { ko: STR_KO, en: STR_EN, 'zh-CN': STR_ZH, ja: STR_JA, vi: STR_VI, tl: STR_TL, id: STR_ID, ru: STR_RU, fr: STR_FR, es: STR_ES, ar: STR_AR, de: STR_DE, tr: STR_TR, uk: STR_UK };
  ...
  var TAB_LABEL_TR = {
    "overview": "F-4 genel bakış",
    "overseasApplication": "Yurt dışı temsilcilikte başvuru",
    "residenceReport": "Yurt içi ikamet bildirimi / kartı",
    "statusChange": "Kore'de statü değişikliği",
    "country": "Ülkeye göre",
    "faq": "F-4 sık sorulan sorular"
  };
  var TAB_LABEL_UK = {
    "overview": "F-4 огляд",
    "overseasApplication": "Подання в закордонному представництві",
    "residenceReport": "Звіт про місце проживання в країні / картка",
    "statusChange": "Зміна статусу в Кореї",
    "country": "За країною",
    "faq": "F-4 поширені запитання"
  };
  var TAB_LABEL_PACKS = { ko: TAB_LABEL_KO, en: TAB_LABEL_EN, 'zh-CN': TAB_LABEL_ZH, ja: TAB_LABEL_JA, vi: TAB_LABEL_VI, tl: TAB_LABEL_TL, id: TAB_LABEL_ID, ru: TAB_LABEL_RU, fr: TAB_LABEL_FR, es: TAB_LABEL_ES, ar: TAB_LABEL_AR, de: TAB_LABEL_DE, tr: TAB_LABEL_TR, uk: TAB_LABEL_UK };
