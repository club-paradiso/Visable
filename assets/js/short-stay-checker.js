...
(function () {
  ...
  var STR_JA = {
    title: '国籍別の短期入国経路を確認',
    titleEn: 'Short-stay entry checker',
    subtitle: '国籍・パスポート・訪問地域・目的をもとに、無査証、済州無査証、C-3査証の可能性を確認します。',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. 国籍（パスポート発給国）',
    countryPlaceholder: '例: ベトナム、Vietnam、日本、United States',
    countryHelper: '国名を入力すると候補を表示します。',
    countryMissing: 'まず国籍を入力してください。',
    countryNotFound: '国名が見つかりませんでした。英語名または韓国語の国名で入力し直してください。',
    passportLabel: '2. パスポートの種類',
    purposeLabel: '3. 訪問目的',
    destinationLabel: '4. 訪問地域',
    stayLabel: '5. 予定滞在日数',
    stayHelper: '何日ほど滞在する予定ですか？',
    ageLabel: '年齢層（任意）',
    submit: '経路を確認する',
    reset: '入力し直す',
    loading: '公式リスト データを読み込んでいます…',
    fetchFail: '国別リストのデータを読み込めませんでした。この状態では無査証入国が可能かどうかをご案内できません。K-ETA公式サイト、ビザポータル、または管轄の在外公館で直接ご確認ください。',
    resultPath: 'おすすめの経路',
    resultWhy: 'なぜこの経路ですか？',
    resultNext: '次にすべきこと',
    resultWarn: '必ず確認する点',
    resultOfficial: '公式確認',
    resultAlt: 'ほかの可能性',
    sourceBadgeVerified: '公式基準を確認済み',
    sourceBadgeNeedsRefresh: '公式の最新性の確認が必要',
    sourceBadgePartial: '一部の資料に基づく',
    sourceDatePrefix: '出典基準日',
    statusLikely: '確認可能な経路',
    statusJejuFree: '済州無査証が可能',
    statusTransitNoVisa: '乗り継ぎ査証不要',
    statusTransitVisa: '純粋乗り継ぎ査証が必要',
    statusVisaRequired: '査証が必要',
    statusNotAvailable: '不可',
    statusCheck: '公式確認が必要',
    srcItemDate: '基準日',
    srcItemConfidence: '信頼度',
    dataNote: '資料の注意',
    srcDetailsSummary: '出典・資料の根拠（詳細）',
    srcBasisLine: 'この回答が根拠とする公式の出典:',
    srcMetaLine: '出典メタデータ全体: data/short-stay/sources.json',
    srcLegalLine: 'この案内は保存された公式リストの写しに基づく参考情報であり、法的効力はありません。最終確認はK-ETA・ビザポータル・在外公館・1345で行ってください。',
    countrySuggestAria: '国の候補',
    dataLoadFailBadge: 'データ読み込み失敗 — 公式サイトで直接確認が必要',
    ctaSuffix: ' — 自分の国籍で無査証・済州・C-3の可能性を確認する',
    similarCountry: '類似の国',
    notInListNote: '現在反映されているリスト データにない国の場合、一般的に査証（C-3など）の申請、または在外公館・1345での公式確認が必要です。',
    linkKeta: 'K-ETAを確認する',
    linkVisaPortal: 'ビザポータルを確認する',
    linkHikorea: 'HiKorea',
    link1345: '1345での確認を推奨',
    linkMission: '在外公館で確認する'
  };
  var STR_VI = {
    title: 'Kiểm tra lộ trình nhập cảnh ngắn hạn theo quốc tịch',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Kiểm tra khả năng nhập cảnh miễn thị thực, miễn thị thực Jeju và thị thực C-3 dựa trên quốc tịch, hộ chiếu, khu vực đến và mục đích.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Quốc tịch (nước cấp hộ chiếu)',
    countryPlaceholder: 'VD: Việt Nam, Vietnam, Nhật Bản, United States',
    countryHelper: 'Nhập tên quốc gia để xem các gợi ý.',
    countryMissing: 'Vui lòng nhập quốc tịch trước.',
    countryNotFound: 'Không tìm thấy tên quốc gia. Hãy nhập lại bằng tên tiếng Anh hoặc tiếng Hàn của quốc gia.',
    passportLabel: '2. Loại hộ chiếu',
    purposeLabel: '3. Mục đích đến',
    destinationLabel: '4. Khu vực đến',
    stayLabel: '5. Số ngày dự kiến lưu trú',
    stayHelper: 'Bạn dự định lưu trú khoảng bao nhiêu ngày?',
    ageLabel: 'Nhóm tuổi (tùy chọn)',
    submit: 'Kiểm tra lộ trình',
    reset: 'Nhập lại',
    loading: 'Đang tải dữ liệu danh sách chính thức…',
    fetchFail: 'Không thể tải dữ liệu danh sách theo quốc gia. Ở trạng thái này, chúng tôi không thể cho biết bạn có được nhập cảnh miễn thị thực hay không. Vui lòng kiểm tra trực tiếp trên trang K-ETA chính thức, Cổng thị thực hoặc tại cơ quan đại diện Hàn Quốc có thẩm quyền.',
    resultPath: 'Lộ trình đề xuất',
    resultWhy: 'Vì sao là lộ trình này?',
    resultNext: 'Việc cần làm tiếp theo',
    resultWarn: 'Nhất định phải kiểm tra',
    resultOfficial: 'Xác nhận chính thức',
    resultAlt: 'Khả năng khác',
    sourceBadgeVerified: 'Đã xác nhận tiêu chuẩn chính thức',
    sourceBadgeNeedsRefresh: 'Cần xác nhận tính cập nhật chính thức',
    sourceBadgePartial: 'Dựa trên một phần tài liệu',
    sourceDatePrefix: 'Ngày cơ sở của nguồn',
    statusLikely: 'Lộ trình có thể xác nhận',
    statusJejuFree: 'Có thể miễn thị thực Jeju',
    statusTransitNoVisa: 'Quá cảnh — không cần thị thực',
    statusTransitVisa: 'Quá cảnh thuần túy — cần thị thực',
    statusVisaRequired: 'Cần thị thực',
    statusNotAvailable: 'Không thể',
    statusCheck: 'Cần xác nhận chính thức',
    srcItemDate: 'ngày cơ sở',
    srcItemConfidence: 'độ tin cậy',
    dataNote: 'Lưu ý về tài liệu',
    srcDetailsSummary: 'Nguồn · căn cứ tài liệu (chi tiết)',
    srcBasisLine: 'Nguồn chính thức mà câu trả lời này dựa vào:',
    srcMetaLine: 'Toàn bộ siêu dữ liệu nguồn: data/short-stay/sources.json',
    srcLegalLine: 'Hướng dẫn này là thông tin tham khảo dựa trên bản sao đã lưu của các danh sách chính thức và không có hiệu lực pháp lý. Hãy xác nhận cuối cùng tại K-ETA · Cổng thị thực · cơ quan đại diện Hàn Quốc · 1345.',
    countrySuggestAria: 'Gợi ý quốc gia',
    dataLoadFailBadge: 'Tải dữ liệu thất bại — cần kiểm tra trực tiếp trên trang chính thức',
    ctaSuffix: ' — kiểm tra khả năng miễn thị thực · Jeju · C-3 cho quốc tịch của bạn',
    similarCountry: 'Quốc gia tương tự',
    notInListNote: 'Nếu một quốc gia không có trong dữ liệu danh sách hiện được tải, thông thường bạn cần xin thị thực (như C-3) hoặc xác nhận chính thức tại cơ quan đại diện Hàn Quốc hoặc 1345.',
    linkKeta: 'Kiểm tra K-ETA',
    linkVisaPortal: 'Kiểm tra Cổng thị thực',
    linkHikorea: 'HiKorea',
    link1345: 'Nên xác nhận qua 1345',
    linkMission: 'Kiểm tra tại cơ quan đại diện Hàn Quốc'
  };
  var STR_TL = {
    title: 'Pagsusuri ng short-stay entry route ayon sa nasyonalidad',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Tingnan ang posibilidad ng visa-free entry, Jeju visa-free entry, at C-3 visa batay sa nasyonalidad, pasaporte, destinasyon, at layunin.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Nasyonalidad (bansang nag-isyu ng pasaporte)',
    countryPlaceholder: 'hal. Vietnam, 베트남, Japan, United States',
    countryHelper: 'Mag-type ng pangalan ng bansa para makita ang mga kandidato.',
    countryMissing: 'Pakilagay muna ang iyong nasyonalidad.',
    countryNotFound: 'Hindi natagpuan ang bansa. Subukan muli gamit ang English o Korean na pangalan ng bansa.',
    passportLabel: '2. Uri ng pasaporte',
    purposeLabel: '3. Layunin ng pagbisita',
    destinationLabel: '4. Destinasyon',
    stayLabel: '5. Planong haba ng pananatili',
    stayHelper: 'Mga ilang araw kang planong manatili?',
    ageLabel: 'Pangkat ng edad (opsyonal)',
    submit: 'Tingnan ang ruta',
    reset: 'Magsimulang muli',
    loading: 'Naglo-load ng opisyal na datos ng listahan…',
    fetchFail: 'Hindi ma-load ang datos ng listahan ng bansa. Sa ganitong kalagayan, hindi namin masasabi kung posible ang visa-free entry. Pakitiyak nang direkta sa opisyal na K-ETA site, sa Visa Portal, o sa may hurisdiksyong misyon ng Korea.',
    resultPath: 'Inirerekomendang ruta',
    resultWhy: 'Bakit ang rutang ito?',
    resultNext: 'Susunod na gagawin',
    resultWarn: 'Siguraduhing tingnan',
    resultOfficial: 'Opisyal na pagtiyak',
    resultAlt: 'Ibang posibilidad',
    sourceBadgeVerified: 'Natiyak ang opisyal na pamantayan',
    sourceBadgeNeedsRefresh: 'Kailangang tiyakin ang opisyal na pagiging kasalukuyan',
    sourceBadgePartial: 'Batay sa bahagyang mga pinagmulan',
    sourceDatePrefix: 'Petsang batayan ng pinagmulan',
    statusLikely: 'Posibleng ruta',
    statusJejuFree: 'Posible ang Jeju visa-free',
    statusTransitNoVisa: 'Transit — walang visa',
    statusTransitVisa: 'Purong transit — kailangan ng visa',
    statusVisaRequired: 'Kailangan ng visa',
    statusNotAvailable: 'Hindi available',
    statusCheck: 'Kailangan ng opisyal na pagtiyak',
    srcItemDate: 'petsang batayan',
    srcItemConfidence: 'antas ng tiwala',
    dataNote: 'Paalala sa datos',
    srcDetailsSummary: 'Mga pinagmulan at batayan ng datos (detalye)',
    srcBasisLine: 'Opisyal na pinagmulan na pinagbabatayan ng sagot na ito:',
    srcMetaLine: 'Buong metadata ng pinagmulan: data/short-stay/sources.json',
    srcLegalLine: 'Ang gabay na ito ay reference na impormasyon batay sa naka-imbak na kopya ng mga opisyal na listahan at walang legal na bisa. Tiyakin ang pinal sa K-ETA, Visa Portal, misyon ng Korea, o 1345.',
    countrySuggestAria: 'Mga kandidatong bansa',
    dataLoadFailBadge: 'Bigong mag-load ng datos — tiyakin nang direkta sa opisyal na site',
    ctaSuffix: ' — tingnan ang posibilidad ng visa-free / Jeju / C-3 para sa iyong nasyonalidad',
    similarCountry: 'Mga katulad na bansa',
    notInListNote: 'Kung wala ang isang bansa sa kasalukuyang na-load na datos ng listahan, kadalasang kailangan mong mag-apply ng visa (tulad ng C-3) o magtiyak nang opisyal sa misyon ng Korea o 1345.',
    linkKeta: 'Tingnan ang K-ETA',
    linkVisaPortal: 'Tingnan ang Visa Portal',
    linkHikorea: 'HiKorea',
    link1345: 'Tiyakin sa 1345',
    linkMission: 'Tingnan sa misyon ng Korea'
  };
  var STR_ID = {
    title: 'Periksa jalur masuk jangka pendek per kewarganegaraan',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Periksa kemungkinan masuk bebas visa, bebas visa Jeju, dan visa C-3 berdasarkan kewarganegaraan, paspor, wilayah tujuan, dan tujuan kunjungan.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Kewarganegaraan (negara penerbit paspor)',
    countryPlaceholder: 'Contoh: Vietnam, 베트남, Jepang, United States',
    countryHelper: 'Ketik nama negara untuk melihat kandidat.',
    countryMissing: 'Silakan masukkan kewarganegaraan Anda terlebih dahulu.',
    countryNotFound: 'Negara tidak ditemukan. Coba lagi dengan nama negara dalam bahasa Inggris atau Korea.',
    passportLabel: '2. Jenis paspor',
    purposeLabel: '3. Tujuan kunjungan',
    destinationLabel: '4. Wilayah tujuan',
    stayLabel: '5. Perkiraan lama tinggal',
    stayHelper: 'Kira-kira berapa hari Anda berencana tinggal?',
    ageLabel: 'Kelompok usia (opsional)',
    submit: 'Periksa jalur',
    reset: 'Mulai ulang',
    loading: 'Memuat data daftar resmi…',
    fetchFail: 'Tidak dapat memuat data daftar per negara. Dalam keadaan ini, kami tidak dapat memberi tahu apakah masuk bebas visa dimungkinkan. Silakan periksa langsung di situs resmi K-ETA, Portal Visa, atau pada perwakilan Korea yang berwenang.',
    resultPath: 'Jalur yang disarankan',
    resultWhy: 'Mengapa jalur ini?',
    resultNext: 'Yang harus dilakukan selanjutnya',
    resultWarn: 'Wajib diperiksa',
    resultOfficial: 'Konfirmasi resmi',
    resultAlt: 'Kemungkinan lain',
    sourceBadgeVerified: 'Standar resmi terverifikasi',
    sourceBadgeNeedsRefresh: 'Perlu memverifikasi kemutakhiran resmi',
    sourceBadgePartial: 'Berdasarkan sebagian sumber',
    sourceDatePrefix: 'Tanggal dasar sumber',
    statusLikely: 'Jalur yang mungkin',
    statusJejuFree: 'Bebas visa Jeju dimungkinkan',
    statusTransitNoVisa: 'Transit — tanpa visa',
    statusTransitVisa: 'Transit murni — perlu visa',
    statusVisaRequired: 'Perlu visa',
    statusNotAvailable: 'Tidak tersedia',
    statusCheck: 'Perlu konfirmasi resmi',
    srcItemDate: 'tanggal dasar',
    srcItemConfidence: 'tingkat keyakinan',
    dataNote: 'Catatan data',
    srcDetailsSummary: 'Sumber & dasar data (rincian)',
    srcBasisLine: 'Sumber resmi yang menjadi dasar jawaban ini:',
    srcMetaLine: 'Seluruh metadata sumber: data/short-stay/sources.json',
    srcLegalLine: 'Panduan ini adalah informasi rujukan berdasarkan salinan tersimpan dari daftar resmi dan tidak memiliki kekuatan hukum. Konfirmasi akhir di K-ETA, Portal Visa, perwakilan Korea, atau 1345.',
    countrySuggestAria: 'Kandidat negara',
    dataLoadFailBadge: 'Gagal memuat data — perlu memeriksa langsung di situs resmi',
    ctaSuffix: ' — periksa kemungkinan bebas visa / Jeju / C-3 untuk kewarganegaraan Anda',
    similarCountry: 'Negara serupa',
    notInListNote: 'Jika suatu negara tidak ada dalam data daftar yang sedang dimuat, umumnya Anda perlu mengajukan visa (seperti C-3) atau melakukan konfirmasi resmi pada perwakilan Korea atau 1345.',
    linkKeta: 'Periksa K-ETA',
    linkVisaPortal: 'Periksa Portal Visa',
    linkHikorea: 'HiKorea',
    link1345: 'Disarankan konfirmasi melalui 1345',
    linkMission: 'Periksa pada perwakilan Korea'
  };
  var STR_RU = {
    title: 'Проверка путей краткосрочного въезда по гражданству',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Проверьте возможность безвизового въезда, безвизового въезда на Чеджу и визы C-3 на основе гражданства, паспорта, региона назначения и цели поездки.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Гражданство (страна выдачи паспорта)',
    countryPlaceholder: 'напр.: Вьетнам, Vietnam, Япония, United States',
    countryHelper: 'Введите название страны, чтобы увидеть варианты.',
    countryMissing: 'Сначала укажите гражданство.',
    countryNotFound: 'Страна не найдена. Попробуйте снова, введя название страны на английском или корейском языке.',
    passportLabel: '2. Тип паспорта',
    purposeLabel: '3. Цель поездки',
    destinationLabel: '4. Регион назначения',
    stayLabel: '5. Планируемое число дней пребывания',
    stayHelper: 'Примерно сколько дней вы планируете остаться?',
    ageLabel: 'Возрастная группа (необязательно)',
    submit: 'Проверить путь',
    reset: 'Начать заново',
    loading: 'Загрузка данных официального списка…',
    fetchFail: 'Не удалось загрузить данные списка по странам. В этом состоянии мы не можем сообщить, возможен ли безвизовый въезд. Пожалуйста, проверьте напрямую на официальном сайте K-ETA, на Визовом портале или в компетентном корейском представительстве.',
    resultPath: 'Рекомендуемый путь',
    resultWhy: 'Почему этот путь?',
    resultNext: 'Что делать дальше',
    resultWarn: 'Обязательно проверьте',
    resultOfficial: 'Официальная проверка',
    resultAlt: 'Другие возможности',
    sourceBadgeVerified: 'Официальный стандарт подтверждён',
    sourceBadgeNeedsRefresh: 'Требуется проверка актуальности официальных данных',
    sourceBadgePartial: 'На основе части источников',
    sourceDatePrefix: 'Дата источника',
    statusLikely: 'Возможный путь',
    statusJejuFree: 'Безвизовый въезд на Чеджу возможен',
    statusTransitNoVisa: 'Транзит — без визы',
    statusTransitVisa: 'Чистый транзит — нужна виза',
    statusVisaRequired: 'Нужна виза',
    statusNotAvailable: 'Недоступно',
    statusCheck: 'Нужна официальная проверка',
    srcItemDate: 'дата',
    srcItemConfidence: 'уровень достоверности',
    dataNote: 'Примечание к данным',
    srcDetailsSummary: 'Источники и основа данных (подробно)',
    srcBasisLine: 'Официальные источники, на которые опирается этот ответ:',
    srcMetaLine: 'Полные метаданные источников: data/short-stay/sources.json',
    srcLegalLine: 'Это руководство является справочной информацией на основе сохранённых копий официальных списков и не имеет юридической силы. Окончательно подтвердите в K-ETA, на Визовом портале, в корейском представительстве или по телефону 1345.',
    countrySuggestAria: 'Варианты стран',
    dataLoadFailBadge: 'Не удалось загрузить данные — проверьте напрямую на официальном сайте',
    ctaSuffix: ' — проверьте возможность безвизового въезда / Чеджу / C-3 для вашего гражданства',
    similarCountry: 'Похожие страны',
    notInListNote: 'Если страны нет в загруженных данных списка, как правило, требуется подать заявление на визу (например, C-3) либо официально уточнить в корейском представительстве или по телефону 1345.',
    linkKeta: 'Проверить K-ETA',
    linkVisaPortal: 'Проверить Визовый портал',
    linkHikorea: 'HiKorea',
    link1345: 'Рекомендуем уточнить по 1345',
    linkMission: 'Уточнить в корейском представительстве'
  };
  var STR_FR = {
    title: 'Vérification des parcours d’entrée de court séjour par nationalité',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Vérifiez les possibilités d’entrée sans visa, d’entrée sans visa à Jeju et de visa C-3 en fonction de la nationalité, du passeport, de la destination et de l’objet de la visite.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Nationalité (pays de délivrance du passeport)',
    countryPlaceholder: 'ex. : Vietnam, 베트남, Japon, United States',
    countryHelper: 'Saisissez un nom de pays pour voir les suggestions.',
    countryMissing: 'Veuillez d’abord saisir votre nationalité.',
    countryNotFound: 'Pays introuvable. Réessayez avec le nom du pays en anglais ou en coréen.',
    passportLabel: '2. Type de passeport',
    purposeLabel: '3. Objet de la visite',
    destinationLabel: '4. Destination',
    stayLabel: '5. Durée de séjour prévue',
    stayHelper: 'Combien de jours environ prévoyez-vous de rester ?',
    ageLabel: 'Tranche d’âge (facultatif)',
    submit: 'Vérifier le parcours',
    reset: 'Recommencer',
    loading: 'Chargement des données de la liste officielle…',
    fetchFail: 'Impossible de charger les données de la liste par pays. Dans cet état, nous ne pouvons pas vous indiquer si l’entrée sans visa est possible. Veuillez vérifier directement sur le site officiel K-ETA, sur le Portail des visas ou auprès de la mission coréenne compétente.',
    resultPath: 'Parcours recommandé',
    resultWhy: 'Pourquoi ce parcours ?',
    resultNext: 'Que faire ensuite',
    resultWarn: 'À vérifier impérativement',
    resultOfficial: 'Vérification officielle',
    resultAlt: 'Autres possibilités',
    sourceBadgeVerified: 'Norme officielle vérifiée',
    sourceBadgeNeedsRefresh: 'Vérifier l’actualité officielle',
    sourceBadgePartial: 'Basé sur des sources partielles',
    sourceDatePrefix: 'Source à la date du',
    statusLikely: 'Parcours possible',
    statusJejuFree: 'Entrée sans visa à Jeju possible',
    statusTransitNoVisa: 'Transit — sans visa',
    statusTransitVisa: 'Transit pur — visa requis',
    statusVisaRequired: 'Visa requis',
    statusNotAvailable: 'Non disponible',
    statusCheck: 'Vérification officielle nécessaire',
    srcItemDate: 'à la date du',
    srcItemConfidence: 'niveau de confiance',
    dataNote: 'Note sur les données',
    srcDetailsSummary: 'Sources et base des données (détails)',
    srcBasisLine: 'Sources officielles sur lesquelles repose cette réponse :',
    srcMetaLine: 'Métadonnées complètes des sources : data/short-stay/sources.json',
    srcLegalLine: 'Ces informations sont fournies à titre indicatif sur la base de copies enregistrées des listes officielles et n’ont aucune valeur juridique. Confirmez en dernier ressort auprès de K-ETA, du Portail des visas, d’une mission coréenne ou du 1345.',
    countrySuggestAria: 'Pays suggérés',
    dataLoadFailBadge: 'Échec du chargement des données — vérifiez directement sur le site officiel',
    ctaSuffix: ' — vérifiez les possibilités sans visa / Jeju / C-3 pour votre nationalité',
    similarCountry: 'Pays similaires',
    notInListNote: 'Si un pays ne figure pas dans les données de la liste actuellement chargées, vous devez en général demander un visa (tel que le C-3) ou obtenir une confirmation officielle auprès d’une mission coréenne ou du 1345.',
    linkKeta: 'Vérifier le K-ETA',
    linkVisaPortal: 'Vérifier le Portail des visas',
    linkHikorea: 'HiKorea',
    link1345: 'Vérification via le 1345 recommandée',
    linkMission: 'Vérifier auprès d’une mission coréenne'
  };
  var STR_ES = {
    title: 'Consulta de rutas de entrada de corta estancia por nacionalidad',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Consulte las posibilidades de entrada sin visado, entrada sin visado a Jeju y visado C-3 según la nacionalidad, el pasaporte, el destino y el motivo de la visita.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Nacionalidad (país emisor del pasaporte)',
    countryPlaceholder: 'p. ej.: Vietnam, 베트남, Japón, United States',
    countryHelper: 'Escriba el nombre de un país para ver los candidatos.',
    countryMissing: 'Introduzca primero su nacionalidad.',
    countryNotFound: 'País no encontrado. Inténtelo de nuevo con el nombre del país en inglés o en coreano.',
    passportLabel: '2. Tipo de pasaporte',
    purposeLabel: '3. Motivo de la visita',
    destinationLabel: '4. Destino',
    stayLabel: '5. Duración prevista de la estancia',
    stayHelper: '¿Cuántos días tiene previsto quedarse aproximadamente?',
    ageLabel: 'Grupo de edad (opcional)',
    submit: 'Consultar ruta',
    reset: 'Empezar de nuevo',
    loading: 'Cargando los datos de la lista oficial…',
    fetchFail: 'No se pudieron cargar los datos de la lista por países. En este estado no podemos indicarle si es posible la entrada sin visado. Verifíquelo directamente en el sitio oficial de K-ETA, en el Portal de Visados o en la misión coreana competente.',
    resultPath: 'Ruta recomendada',
    resultWhy: '¿Por qué esta ruta?',
    resultNext: 'Qué hacer a continuación',
    resultWarn: 'Asegúrese de comprobar',
    resultOfficial: 'Verificación oficial',
    resultAlt: 'Otras posibilidades',
    sourceBadgeVerified: 'Estándar oficial verificado',
    sourceBadgeNeedsRefresh: 'Verificar la actualidad oficial',
    sourceBadgePartial: 'Basado en fuentes parciales',
    sourceDatePrefix: 'Fuente con fecha de',
    statusLikely: 'Ruta posible',
    statusJejuFree: 'Entrada sin visado a Jeju posible',
    statusTransitNoVisa: 'Tránsito — sin visado',
    statusTransitVisa: 'Tránsito puro — se requiere visado',
    statusVisaRequired: 'Se requiere visado',
    statusNotAvailable: 'No disponible',
    statusCheck: 'Se requiere verificación oficial',
    srcItemDate: 'con fecha de',
    srcItemConfidence: 'nivel de confianza',
    dataNote: 'Nota sobre los datos',
    srcDetailsSummary: 'Fuentes y base de los datos (detalles)',
    srcBasisLine: 'Fuentes oficiales en las que se basa esta respuesta:',
    srcMetaLine: 'Metadatos completos de las fuentes: data/short-stay/sources.json',
    srcLegalLine: 'Esta orientación es información de referencia basada en copias almacenadas de listas oficiales y no tiene efecto jurídico. Confirme de forma definitiva en K-ETA, el Portal de Visados, una misión coreana o el 1345.',
    countrySuggestAria: 'Países candidatos',
    dataLoadFailBadge: 'Error al cargar los datos — verifíquelo directamente en el sitio oficial',
    ctaSuffix: ' — consulte las posibilidades sin visado / Jeju / C-3 para su nacionalidad',
    similarCountry: 'Países similares',
    notInListNote: 'Si un país no figura en los datos de la lista cargados actualmente, por lo general debe solicitar un visado (como el C-3) o confirmarlo oficialmente en una misión coreana o el 1345.',
    linkKeta: 'Consultar K-ETA',
    linkVisaPortal: 'Consultar el Portal de Visados',
    linkHikorea: 'HiKorea',
    link1345: 'Se recomienda verificar mediante el 1345',
    linkMission: 'Consultar en una misión coreana'
  };
  var STR_AR = {
    title: 'التحقق من مسارات الدخول قصير الأمد حسب الجنسية',
    titleEn: 'Short-stay entry checker',
    subtitle: 'تحقق من إمكانية الدخول دون تأشيرة، والدخول دون تأشيرة إلى جيجو، وتأشيرة C-3 بناءً على الجنسية وجواز السفر ومنطقة الوجهة والغرض.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. الجنسية (الدولة المُصدِّرة لجواز السفر)',
    countryPlaceholder: 'مثال: فيتنام، Vietnam، اليابان، United States',
    countryHelper: 'اكتب اسم الدولة لعرض المقترحات.',
    countryMissing: 'يرجى إدخال جنسيتك أولاً.',
    countryNotFound: 'لم يتم العثور على الدولة. أعد المحاولة باسم الدولة بالإنجليزية أو الكورية.',
    passportLabel: '2. نوع جواز السفر',
    purposeLabel: '3. غرض الزيارة',
    destinationLabel: '4. منطقة الوجهة',
    stayLabel: '5. عدد أيام الإقامة المتوقعة',
    stayHelper: 'كم يوماً تقريباً تنوي البقاء؟',
    ageLabel: 'الفئة العمرية (اختياري)',
    submit: 'تحقق من المسار',
    reset: 'إعادة الإدخال',
    loading: 'جارٍ تحميل بيانات القائمة الرسمية…',
    fetchFail: 'تعذّر تحميل بيانات القائمة حسب الدولة. في هذه الحالة لا يمكننا إخبارك بإمكانية الدخول دون تأشيرة. يرجى التحقق مباشرةً من موقع K-ETA الرسمي أو بوابة التأشيرات أو لدى البعثة الكورية المختصة.',
    resultPath: 'المسار الموصى به',
    resultWhy: 'لماذا هذا المسار؟',
    resultNext: 'ما يجب فعله بعد ذلك',
    resultWarn: 'تأكد من التحقق',
    resultOfficial: 'التحقق الرسمي',
    resultAlt: 'احتمالات أخرى',
    sourceBadgeVerified: 'تم التحقق من المعيار الرسمي',
    sourceBadgeNeedsRefresh: 'يلزم التحقق من حداثة المصدر الرسمي',
    sourceBadgePartial: 'استناداً إلى مصادر جزئية',
    sourceDatePrefix: 'تاريخ المصدر',
    statusLikely: 'مسار ممكن',
    statusJejuFree: 'الدخول دون تأشيرة إلى جيجو ممكن',
    statusTransitNoVisa: 'عبور — دون تأشيرة',
    statusTransitVisa: 'عبور بحت — تلزم تأشيرة',
    statusVisaRequired: 'تلزم تأشيرة',
    statusNotAvailable: 'غير متاح',
    statusCheck: 'يلزم التحقق الرسمي',
    srcItemDate: 'تاريخ المصدر',
    srcItemConfidence: 'درجة الموثوقية',
    dataNote: 'ملاحظة على البيانات',
    srcDetailsSummary: 'المصادر وأساس البيانات (التفاصيل)',
    srcBasisLine: 'المصادر الرسمية التي تستند إليها هذه الإجابة:',
    srcMetaLine: 'بيانات المصادر الوصفية الكاملة: data/short-stay/sources.json',
    srcLegalLine: 'هذا الإرشاد معلومات مرجعية تستند إلى نسخ مخزّنة من القوائم الرسمية وليس له أثر قانوني. للتأكيد النهائي راجع K-ETA أو بوابة التأشيرات أو البعثة الكورية أو 1345.',
    countrySuggestAria: 'الدول المقترحة',
    dataLoadFailBadge: 'فشل تحميل البيانات — يلزم التحقق مباشرةً من الموقع الرسمي',
    ctaSuffix: ' — تحقق من إمكانيات الدخول دون تأشيرة / جيجو / C-3 لجنسيتك',
    similarCountry: 'دول مشابهة',
    notInListNote: 'إذا لم تكن الدولة ضمن بيانات القائمة المحمّلة حالياً، فعادةً ما يلزم التقدّم بطلب تأشيرة (مثل C-3) أو التأكيد الرسمي لدى البعثة الكورية أو 1345.',
    linkKeta: 'تحقق من K-ETA',
    linkVisaPortal: 'تحقق من بوابة التأشيرات',
    linkHikorea: 'HiKorea',
    link1345: 'يُنصح بالتحقق عبر 1345',
    linkMission: 'تحقق لدى البعثة الكورية'
  };
  var STR_DE = {
    title: 'Prüfung der Kurzeinreisewege nach Staatsangehörigkeit',
    titleEn: 'Short-stay entry checker',
    subtitle: 'Prüfen Sie die Möglichkeiten der visafreien Einreise, der visafreien Einreise nach Jeju und des C-3-Visums anhand von Staatsangehörigkeit, Pass, Zielregion und Zweck.',
    eyebrow: 'Short-stay entry',
    countryLabel: '1. Staatsangehörigkeit (Ausstellungsland des Passes)',
    countryPlaceholder: 'z. B. Vietnam, 베트남, Japan, United States',
    countryHelper: 'Geben Sie einen Ländernamen ein, um Vorschläge zu sehen.',
    countryMissing: 'Bitte geben Sie zuerst Ihre Staatsangehörigkeit ein.',
    countryNotFound: 'Land nicht gefunden. Versuchen Sie es erneut mit dem englischen oder koreanischen Ländernamen.',
    passportLabel: '2. Passart',
    purposeLabel: '3. Zweck des Besuchs',
    destinationLabel: '4. Zielregion',
    stayLabel: '5. Geplante Aufenthaltsdauer',
    stayHelper: 'Wie viele Tage möchten Sie ungefähr bleiben?',
    ageLabel: 'Altersgruppe (optional)',
    submit: 'Weg prüfen',
    reset: 'Neu beginnen',
    loading: 'Offizielle Listendaten werden geladen…',
    fetchFail: 'Die Listendaten nach Ländern konnten nicht geladen werden. In diesem Zustand können wir nicht angeben, ob eine visafreie Einreise möglich ist. Bitte prüfen Sie es direkt auf der offiziellen K-ETA-Website, im Visa-Portal oder bei der zuständigen koreanischen Auslandsvertretung.',
    resultPath: 'Empfohlener Weg',
    resultWhy: 'Warum dieser Weg?',
    resultNext: 'Nächste Schritte',
    resultWarn: 'Unbedingt prüfen',
    resultOfficial: 'Offizielle Bestätigung',
    resultAlt: 'Weitere Möglichkeiten',
    sourceBadgeVerified: 'Offizieller Standard bestätigt',
    sourceBadgeNeedsRefresh: 'Aktualität der offiziellen Angaben prüfen',
    sourceBadgePartial: 'Auf Basis teilweiser Quellen',
    sourceDatePrefix: 'Quelle mit Stand vom',
    statusLikely: 'Möglicher Weg',
    statusJejuFree: 'Visafreie Einreise nach Jeju möglich',
    statusTransitNoVisa: 'Transit — kein Visum',
    statusTransitVisa: 'Reiner Transit — Visum erforderlich',
    statusVisaRequired: 'Visum erforderlich',
    statusNotAvailable: 'Nicht verfügbar',
    statusCheck: 'Offizielle Bestätigung erforderlich',
    srcItemDate: 'Stand',
    srcItemConfidence: 'Vertrauensgrad',
    dataNote: 'Hinweis zu den Daten',
    srcDetailsSummary: 'Quellen & Datengrundlage (Details)',
    srcBasisLine: 'Offizielle Quellen, auf die sich diese Antwort stützt:',
    srcMetaLine: 'Vollständige Quellen-Metadaten: data/short-stay/sources.json',
    srcLegalLine: 'Diese Hinweise sind Referenzinformationen auf Basis gespeicherter Kopien offizieller Listen und haben keine rechtliche Wirkung. Bestätigen Sie abschließend bei K-ETA, im Visa-Portal, bei einer koreanischen Auslandsvertretung oder unter 1345.',
    countrySuggestAria: 'Ländervorschläge',
    dataLoadFailBadge: 'Laden der Daten fehlgeschlagen — bitte direkt auf der offiziellen Website prüfen',
    ctaSuffix: ' — Möglichkeiten visafrei / Jeju / C-3 für Ihre Staatsangehörigkeit prüfen',
    similarCountry: 'Ähnliche Länder',
    notInListNote: 'Wenn ein Land nicht in den aktuell geladenen Listendaten enthalten ist, müssen Sie in der Regel ein Visum (z. B. C-3) beantragen oder es offiziell bei einer koreanischen Auslandsvertretung oder unter 1345 bestätigen lassen.',
    linkKeta: 'K-ETA prüfen',
    linkVisaPortal: 'Visa-Portal prüfen',
    linkHikorea: 'HiKorea',
  ...
  function optLabel(o) {
    ...
    return (field && o[field]) ? o[field] : o.label;
  }
  ...
  function getShortStayEntryOptions(input, rules) {
    ...
    if (purpose === 'overseas_korean') {
      ...
      r.steps = [
        ...
        '단순 방문이면 C-3-8, 장기 체류·취업 계획이 있으면 F-4 경로를 검토하세요(이 페이지의 "F-4 절차 확인하기" 안내 참고).',
