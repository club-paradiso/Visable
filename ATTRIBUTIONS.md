...
Blank official forms under `assets/forms/pdf/` are Korean government public forms: 통합신청서 (출입국관리법 시행규칙 별지 제34호서식) and 재외동포(F-4) 통합신청서·국내거소신고서 (재외동포법 시행규칙 별지 제1호서식), retained verbatim from the law.go.kr official sources catalogued in `docs/forms_official/`.
