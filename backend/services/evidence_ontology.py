...
LEGAL_ISSUE_DIMENSIONS: Tuple[str, ...] = (
    ...
    "employment_restriction", "employment_condition", "study_on_non_study_status",
...
SOURCE_FAMILY_ROUTING: Dict[str, Tuple[str, ...]] = {
    ...
    "employment_condition": _ACTIVITY_AUTHORITY_ROUTE,
...
ISSUE_CONCEPT_KO: Dict[str, str] = {
    ...
    "employment_condition": "근무처 고용조건 직종 임금 부합",
...
ISSUE_CONCEPT_EN: Dict[str, str] = {
    ...
    "employment_condition": "employment conditions wage hours duties alignment",
